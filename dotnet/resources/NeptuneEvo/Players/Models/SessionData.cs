...
namespace NeptuneEvo.Players.Models
{
    public class SessionData
    {
        ...
        public Container CurrentContainer { get; set; } = null;
        public DateTime LastDamage { get; set; } = DateTime.MinValue;
        public ChristmasEventPlayerData ChristmasEvent { get; set; } = new ChristmasEventPlayerData();
        public int SkillBoostTime { get; set; } = 0;
        public bool HairStyled { get; set; } = false;
        public int HairStyledTime { get; set; } = 0;
        public bool SalaryBonusActive { get; set; } = false;
        public int SalaryBonusTime { get; set; } = 0;
        public int RecoveryTime { get; set; } = 0;
        public CrewSessionData CrewSession { get; set; } = new CrewSessionData();
