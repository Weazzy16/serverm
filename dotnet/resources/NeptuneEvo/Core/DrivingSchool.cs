...
namespace NeptuneEvo.Core
{
    class DrivingSchool : Script
    {
        ...
        private static Vector3 enterSchool = new Vector3(-713.46576, -1297.2925, 5.1019206);
        ...
        public void onResourceStart()
        {
            try
            {
                ...
                PedSystem.Repository.CreateQuest("mp_m_securoguard_01", enterSchool, -50.775936f, title: "~y~NPC~w~ Офицер Бенсон\nВыдача лицензий", colShapeEnums: ColShapeEnums.DriveSchool);
