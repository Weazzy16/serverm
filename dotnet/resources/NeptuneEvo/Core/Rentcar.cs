...
namespace NeptuneEvo.Core
{
    ...
    class Rentcar : Script
    {
        ...
        public static RentCarData[] RentCarsData =
        {
            ...
            //new RentCarData(0, "kiastinger", 15, new List<RentCarId>() { RentCarId.None }),
            //new RentCarData(1, "rio", 25, new List<RentCarId>() { RentCarId.None }),
            //new RentCarData(2, "Retinue", 65, new List<RentCarId>() { RentCarId.None }),
            //new RentCarData(3, "priora", 70, new List<RentCarId>() { RentCarId.None }),
            //new RentCarData(4, "urban", 75, new List<RentCarId>() { RentCarId.None }),
            //new RentCarData(5, "samara", 85, new List<RentCarId>() { RentCarId.None }),
            //new RentCarData(6, "accord", 95, new List<RentCarId>() { RentCarId.None }),
            //new RentCarData(7, "focusrs", 200, new List<RentCarId>() { RentCarId.None }), 
            ...
            //new RentCarData(8, "kiastinger", 15, new List<RentCarId>() { RentCarId.Civilian }),
            new RentCarData(8, "rio", 25, new List<RentCarId>() { RentCarId.Civilian }),
            new RentCarData(9, "Retinue", 65, new List<RentCarId>() { RentCarId.Civilian }),
            new RentCarData(10, "priora", 70, new List<RentCarId>() { RentCarId.Civilian }),
            new RentCarData(11, "urban", 75, new List<RentCarId>() { RentCarId.Civilian }),
            new RentCarData(12, "samara", 85, new List<RentCarId>() { RentCarId.Civilian }),
            new RentCarData(13, "accord", 95, new List<RentCarId>() { RentCarId.Civilian }),
            new RentCarData(14, "focusrs", 200, new List<RentCarId>() { RentCarId.Civilian }),
            new RentCarData(15, "kiastinger", 200, new List<RentCarId>() { RentCarId.Civilian }),
            new RentCarData(16, "evo9", 200, new List<RentCarId>() { RentCarId.Civilian }),
            new RentCarData(17, "evo10", 200, new List<RentCarId>() { RentCarId.Civilian }),
            new RentCarData(18, "q8", 200, new List<RentCarId>() { RentCarId.Civilian }),
            new RentCarData(19, "taycan", 200, new List<RentCarId>() { RentCarId.Civilian }),





            //new RentCarData(16, "focusrs", 200, new List<RentCarId>() { RentCarId.None }),
            //new RentCarData(17, "focusrs", 200, new List<RentCarId>() { RentCarId.None }),
            //new RentCarData(18, "focusrs", 200, new List<RentCarId>() { RentCarId.None }),
            //new RentCarData(19, "focusrs", 200, new List<RentCarId>() { RentCarId.None }),
        ...
        private static RentCarSpawn[] RentCarsSpawn = new RentCarSpawn[]
       {
            ...
            //
            new RentCarSpawn(59, new Vector3(-1029.3456, -2733.583, 20.038893), new Vector3(0, 0, -119.90819)),
            new RentCarSpawn(59, new Vector3(-1033.9333, -2731.1113, 20.031338), new Vector3(0, 0, 62.355404)),
            new RentCarSpawn(59, new Vector3(-1039.6235, -2727.966, 20.02519), new Vector3(0, 0, 60.90582)),
        ...
        public static RentZoneData[] RentPedsData = new RentZoneData[]
        {
         ...
         //   new RentZoneData(55, "a_m_y_genstreet_01", LangFunc.GetText(LangType.Ru, DataName.CarRent), new Vector3(619.00146, 2785.884, 43.48116), 7.0879054f, RentCarId.Civilian),
            ...
            new RentZoneData(59, "a_m_y_genstreet_01", LangFunc.GetText(LangType.Ru, DataName.CarRent), new Vector3(-1031.0963, -2736.2034, 20.214434), 120.252785f, RentCarId.Civilian),
        ...
        {
            { RentCarId.Civilian, new RentBlipData(811, LangFunc.GetText(LangType.Ru, DataName.CarRent), 4) },
