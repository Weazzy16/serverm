...
namespace NeptuneEvo.VehicleModel
{
    public class DonateAutoRoom : Script
    {
        ...
        public static Vector3 NpcBuyPosition = new Vector3(-803.20575, -223.81096, 37.226303);
        private static float NpcBuyRotation = 121.35859f;
        //
        ...
        public void Event_ResourceStart()
        {
            ...
            Main.CreateBlip(new Main.BlipData(669, "Donate Autoroom", NpcBuyPosition, 1, true));
            PedSystem.Repository.CreateQuest("s_m_y_blackops_01", NpcBuyPosition, NpcBuyRotation, title: "~y~NPC~w~ Генералиссимус Юки", colShapeEnums: ColShapeEnums.DonateAutoroom);
        }
