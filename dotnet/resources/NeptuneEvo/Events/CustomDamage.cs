...
namespace NeptuneEvo.Events
{
    class CustomDamage : Script
    {
        ...
        private static IReadOnlyDictionary<uint, float> WeaponDamage = new Dictionary<uint, float>()
        {
            ...
            { (uint)WeaponHash.Heavypistol, 20f },
            { (uint)WeaponHash.Vintagepistol, 12f },
            { (uint)WeaponHash.Marksmanpistol, 60f },
            { (uint)WeaponHash.Revolver, 75f },
            { (uint)WeaponHash.Appistol, 11f },
            ...
            { (uint)WeaponHash.Revolver_mk2, 80f },
            { (uint)WeaponHash.Raypistol, 0f },
            { (uint)WeaponHash.CeramicPistol, 15f },
            { (uint)WeaponHash.NavyRevolver, 55f },
            /* SMG */
            { (uint)WeaponHash.Microsmg, 6f },
            { (uint)WeaponHash.Machinepistol, 11f },
            { (uint)WeaponHash.Smg, 7.5f },
            { (uint)WeaponHash.Assaultsmg, 8f },
            { (uint)WeaponHash.Combatpdw, 14f },
            { (uint)WeaponHash.Mg, 18f },
            { (uint)WeaponHash.Combatmg, 20f },
            { (uint)WeaponHash.Gusenberg, 9.5f },
            { (uint)WeaponHash.Minismg, 13f },
            { (uint)WeaponHash.Smg_mk2, 8f },
            { (uint)WeaponHash.Combatmg_mk2, 22f },
            { (uint)WeaponHash.Raycarbine, 0f },
            /* Rifles */
            { (uint)WeaponHash.Assaultrifle, 20f },
            { (uint)WeaponHash.Carbinerifle, 17f },
            { (uint)WeaponHash.Advancedrifle, 17f },
            { (uint)WeaponHash.Specialcarbine, 9.5f },
            { (uint)WeaponHash.Bullpuprifle, 17f },
            { (uint)WeaponHash.Compactrifle, 8f },
            { (uint)WeaponHash.Assaultrifle_mk2, 9.5f },
            { (uint)WeaponHash.Carbinerifle_mk2, 19f },
            { (uint)WeaponHash.Specialcarbine_mk2, 10f },
            { (uint)WeaponHash.Bullpuprifle_mk2, 19f },

            /* Sniper */
            { (uint)WeaponHash.Sniperrifle, 50f },
            { (uint)WeaponHash.Heavysniper, 90f },
            { (uint)WeaponHash.Marksmanrifle, 35f },
            { (uint)WeaponHash.Heavysniper_mk2, 105f },
            { (uint)WeaponHash.Marksmanrifle_mk2, 45f },
            { 0x9D1F17E6, 16.5f },
            /* Shotguns */
            ...
            { (uint)WeaponHash.Heavyshotgun, 45f },
