...
{ 
    ...
    { 
        ...
        public static Vector3 CloakroomPosition = new Vector3(-587.82776, -206.50705, 38.168884);
        public static Vector3 SecondCloakroomPosition = new Vector3(2522.4473f, -330.00107f, 94f);
        private static Vector3 StockPosition = new Vector3(-581.74524, -216.98766, 38.16885);
        public static Vector3 GiveGunPosition = new Vector3(-577.7141, -220.01685, 38.168846);
        ...
        public void OnResourceStartHandler()
        {
            try
            {
                Main.CreateBlip(new Main.BlipData(419, "Правительство", new Vector3(-545.02136, -204.28348, 38.2), 4, true));
            ...
            { 
                ...
                { 
                    ...
                    case 4: //"armor": 
                        ...
                        else if (Chars.Repository.AddNewItem(player, $"char_{player.GetUUID()}", "inventory", ItemId.BodyArmor, 1, "100_True") == -1)
                        { 
