    ...
    class Army : Script
    {
        ...
        public void onResourceStart()
        {
            try
            {
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Нажмите\n~r~'Взаимодействие'"), new Vector3(ArmyCheckpoints[10].X, ArmyCheckpoints[10].Y, ArmyCheckpoints[10].Z), 5F, 0.3F, 0, new Color(255, 255, 255));
                ...
                CustomColShape.CreateCylinderColShape(ArmyCheckpoints[12], 1, 2, 0, ColShapeEnums.FractionArmy, 11);
                ...
                NAPI.Marker.CreateMarker(21, ArmyCheckpoints[10], new Vector3(), new Vector3(), 1f, new Color(255, 255, 255, 220));
                ...
                PedSystem.Repository.CreateQuest("s_m_m_marine_01", new Vector3(-2323.739, 3394.1162, 30.816582), -50.05095f, title: "~y~NPC~w~ Рекрут Астраханский\nВызвать сотрудника", colShapeEnums: ColShapeEnums.CallArmyMember);
            }
        ...
        {
            new Vector3(-2274.3477, 3273.869, 30.114063), // guns     0
            new Vector3(-2272.3877, 3277.759, 33.306408), // dressing room    1
            new Vector3(-2455.5305, 2984.2915, 32.810337), // army docks mats     2
            new Vector3(-2360.946, 3249.595, 31.81073), // army lift 1 floor     3
            new Vector3(-2360.66, 3249.115, 91.90369), // army lift 9 floor     4
            new Vector3(-2277.2087, 3277.4722, 30.10732), // army stock    5
            ...
            new Vector3(-2284.8396, 3254.3523, 30.112806), // Общая тревога кнопка 8
            ...
            try
            {
                ...
                switch (index)
                {
                    ...
                    case 3: //armor
                        ...
                        {
                            if (Chars.Repository.AddNewItem(player, $"char_{player.GetUUID()}", "inventory", ItemId.BodyArmor, 1, "100_True") == -1)
                            {
                    ...
                    case 8:
                        ...
                        else armorp = Convert.ToInt32(aItem.Item.Data.Split("_")[0]);
                        int matstoadd;
