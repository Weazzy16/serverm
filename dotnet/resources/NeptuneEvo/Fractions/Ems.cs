...
namespace NeptuneEvo.Fractions
{
    class Ems : Script
    {
        ...
        public static Dictionary<uint, string> weaponHashToString = new Dictionary<uint, string>
    {
        ...
        public static void ReviveFunc(ExtPlayer player, bool reviveonplace = false)
        {
            try
            {
                ...
                if (!reviveonplace)
                {
                    ...
                    {
                        spawnPos = Admin.DemorganPositions[Main.rnd.Next(3)] + new Vector3(0, 0, 1.12);
