        ...
        public static async Task SaveSql(ServerBD db, ExtPlayer player)
        {
            try
            {
                ...
                await db.Characters
                    ...
                    .Set(v => v.Casinochips, characterData.CasinoChips)
                    ...
                    .Set(v => v.Golod, characterData.Golod)
                    .Set(v => v.Water, characterData.Water)
                    ...
                    .Set(v => v.CoinsTime, characterData.CoinsTime)
                    .Set(v => v.ReceivedCoins, characterData.ReceivedCoins)
                    .Set(v => v.Baff, characterData.BaffTime)
                    ...
                    .Set(v => v.EarnedMoneyDay, characterData.EarnedMoneyDay)
                    .Set(v => v.EarnedMoneyMonth, characterData.EarnedMoneyMonth)
                    .Set(v => v.SpentMoney, characterData.SpentMoney)
                    .Set(v => v.SpentMoneyDay, characterData.SpentMoneyDay)
                    .Set(v => v.SpentMoneyMonth, characterData.SpentMoneyMonth)
                ...
                try
                {
                    ...
                    if (character != null)
                    {
                        await db.Characters 
                            ...
                            .Set(c => c.Money, Convert.ToInt64(character.Money) + money) 
                            .UpdateAsync(); 
                    }
                }
                catch (Exception e)
