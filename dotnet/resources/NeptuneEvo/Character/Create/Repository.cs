        ...
        public static async Task<int> Create(ExtPlayer player, string firstName, string lastName)
        {
            try
            {
                ...
                characterData.UUID = await db.InsertWithInt32IdentityAsync(new Characters
                {
                    ...
                    Money = (long)characterData.Money,
                    Casinochips = characterData.CasinoChips,
                    ...
                    CoinsTime = characterData.CoinsTime,
                    ReceivedCoins = characterData.ReceivedCoins,
                    Baff = characterData.BaffTime,
                ...
                Trigger.SetSharedData(player, "UUID", characterData.UUID);
                //
