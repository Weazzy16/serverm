...
namespace Database
{
	...
	public partial class ServerBD : LinqToDB.Data.DataConnection
	{
		...
		public ITable<Achievement>            Achievement            { get { return this.GetTable<Achievement>(); } }
		public ITable<CalendarTask>            CalendarTask            { get { return this.GetTable<CalendarTask>(); } }
		public ITable<CalendarStats>            CalendarStats            { get { return this.GetTable<CalendarStats>(); } }
		public ITable<JackpotGames>            JackpotGames           { get { return this.GetTable<JackpotGames>(); } }
        public ITable<JackpotBets>             JackpotBets            { get { return this.GetTable<JackpotBets>(); } }
		...
		public ITable<CrashGames> CrashGame  => this.GetTable<CrashGames>();
        public ITable<CrashBets>  CrashBets  => this.GetTable<CrashBets>();
		...
		public ITable<Banslogs>            Banslogs                   { get { return this.GetTable<Banslogs>(); } }
		...
		public ITable<Questions>               Questions              { get { return this.GetTable<Questions>(); } }
                public ITable<QuestionMessages>       Questionmessage        { get { return this.GetTable<QuestionMessages>(); } }
	...
	public partial class Characters
	{
		...
		[Column("SecondsSincePayday"),      NotNull               ] public int SecondsSincePayday { get; set; } // int(11)
        ...
        [Column("golod"),           Nullable          ] public int?      Golod             { get; set; } // int(11)
        [Column("water"),           Nullable          ] public int?      Water             { get; set; } // int(11)
        [Column("coinstime"),       Nullable          ] public int?      CoinsTime         { get; set; } // int(11)
        [Column("receivedcoins"),   Nullable          ] public int?      ReceivedCoins     { get; set; } // int(11)
		...
		[Column("casinochips"),     Nullable          ] public int?      Casinochips       { get; set; } 
        ...
        [Column("adminpass"),       Nullable          ] public string    AdminPass         { get; set; } // varchar(50)
        ...
        [Column("earnedmoneyday"),  Nullable          ] public ulong?    EarnedMoneyDay    { get; set; } // bigint(22) unsigned
        [Column("earnedmoneymonth"),  Nullable        ] public ulong?    EarnedMoneyMonth  { get; set; } // bigint(22) unsigned
        [Column("spentmoney"),      Nullable          ] public ulong?    SpentMoney        { get; set; } // bigint(22) unsigned
        [Column("spentmoneyday"),   Nullable          ] public ulong?    SpentMoneyDay     { get; set; } // bigint(22) unsigned
        [Column("spentmoneymonth"), Nullable          ] public ulong?    SpentMoneyMonth   { get; set; } // bigint(22) unsigned
        ...
        [Column("baff"),           Nullable          ] public int?      Baff             { get; set; } // int(11)
    ...
    public partial class Chatcfgs
    {
        ...
        [Column("setting"), Nullable] public string Setting { get; set; } // LONGTEXT
    }
    ...
    [Table("banslogs")]
    public partial class Banslogs
    {
        [Column("auto_id"), PrimaryKey, Identity] public int AutoId { get; set; } // int(11)
        [Column("time"), NotNull] public DateTime Time { get; set; } // datetime
        [Column("admin"), NotNull] public sbyte Fraction { get; set; } // tinyint(2)
	...
	public partial class Organizations
	{
        ...
        [Column("houseid"), Nullable] public int HouseId { get; set; } // int(11)
    }
    ...
    public partial class QuestionMessages
    {
        [Column("id"), PrimaryKey, Identity] public int Id { get; set; } // int(11)
        [Column("question_id"), NotNull] public int QuestionId { get; set; } // int(11)
        [Column("author"), NotNull] public string Author { get; set; } // varchar(50)
        [Column("text"), NotNull] public string Text { get; set; } // text
        [Column("time"), NotNull] public DateTime Time { get; set; } // datetime
    }
    [Table("crash_game")]
    public partial class CrashGames
    {
        [Column("gameId"), PrimaryKey, NotNull] public int GameId { get; set; }     // int(11) PK
        [Column("startAt"), Nullable] public DateTime? StartAt { get; set; }  // datetime
        [Column("endAt"), Nullable] public DateTime? EndAt { get; set; }  // datetime
        [Column("crashAt"), Nullable] public float? CrashAt { get; set; }  // float
        [Column("bank"), NotNull] public int Bank { get; set; }  // int(11)
        [Column("players"), NotNull] public int Players { get; set; }  // int(11)
    }

    [Table("crash_bets")]
    public partial class CrashBets
    {
        [Column("id"), PrimaryKey, Identity] public int Id { get; set; }   // int(11) AI
        [Column("gameId"), NotNull] public int GameId { get; set; }   // int(11)
        [Column("uuid"), NotNull] public int Uuid { get; set; }   // int(11)
        [Column("login"), NotNull] public string Login { get; set; }   // varchar(50)
        [Column("betAmount"), NotNull] public int BetAmount { get; set; }   // int(11)
        [Column("autoTake"), Nullable] public float? AutoTake { get; set; }   // float
        [Column("exitX"), Nullable] public float? ExitX { get; set; }   // float
        [Column("paid"), NotNull] public int Paid { get; set; }   // int(11)
        [Column("createdAt"), NotNull] public DateTime CreatedAt { get; set; }   // datetime
        [Column("paidAt"), Nullable] public DateTime? PaidAt { get; set; }   // datetime
    }
    [Table("questschar")]
    ...
    {
        [Column("userId"), NotNull] public int UserId { get; set; }
        [Column("taskId"), NotNull] public int TaskId { get; set; }
        [Column("count"), NotNull] public int CompletedCount { get; set; }
        [Column("completed"), NotNull] public bool Completed { get; set; }

        // НОВОЕ поле для сброса в 06:00
        [Column("lastUpdate"), NotNull] public DateTime LastUpdate { get; set; }
        [Column("rewardTaken"), NotNull] public bool RewardTaken { get; set; }
    }
    [Table(Name = "calendar_stats")]
    public class CalendarStats
    {
        [Column(Name = "userId"), NotNull] public int UserId { get; set; }
        [Column(Name = "month"), NotNull] public byte Month { get; set; }
        [Column(Name = "completed"), NotNull] public int Completed { get; set; }
        [Column(Name = "skipped"), NotNull] public int Skipped { get; set; }
    }


    [Table("achievements")]
    public partial class Achievement // singular!
    {
        [Column("autoId"), PrimaryKey, Identity] public int AutoId { get; set; }
        [Column("userId"), NotNull] public int UserId { get; set; }
        [Column("achievementId"), NotNull] public int AchievementId { get; set; }
        [Column("completedValue"), NotNull] public int CompletedValue { get; set; }
        [Column("completed"), NotNull] public bool Completed { get; set; }
        [Column("rewarded"), NotNull] public bool Rewarded { get; set; }
    }
	...
	public partial class Vehicles
	{
		...
		[Column("mileage"),       NotNull           ] public int Mileage { get; set; } // int(11)
        [Column("MileageCentimeters")]
        public int MileageCentimeters { get; set; } // Остаток в см (0-99999)
    ...
    [Table("jackpot_game")]
    public partial class JackpotGames
    {
        [Column("gameId"), PrimaryKey, NotNull] public int GameId { get; set; } // int(11)
        [Column("startedAt"), Nullable] public DateTime? StartedAt { get; set; } // datetime
        [Column("endedAt"), Nullable] public DateTime? EndedAt { get; set; } // datetime
        [Column("winner"), Nullable] public int? Winner { get; set; } // int(11)
        [Column("winnerLogin"), Nullable] public string WinnerLogin { get; set; } // varchar(255)
        [Column("winnerGender"), Nullable] public string WinnerGender { get; set; } // varchar(50)
        [Column("winnerAccountId"), Nullable] public int? WinnerAccountId { get; set; } // int(11)
        [Column("winnerServerName"), Nullable] public string WinnerServerName { get; set; } // varchar(255)
        [Column("winnerServerId"), Nullable] public int? WinnerServerId { get; set; } // int(11)
        [Column("winnerAmount"), Nullable] public int? WinnerAmount { get; set; } // int(11)
        [Column("bank"), Nullable] public int? Bank { get; set; } // int(11)
        [Column("winnerChance"), Nullable] public double? WinnerChance { get; set; } // double
        [Column("winnerTicket"), Nullable] public int? WinnerTicket { get; set; } // int(11)
        [Column("winnerCardIndex"), NotNull] public int WinnerCardIndex { get; set; } // int(11)
        [Column("winnerPosition"), NotNull] public double WinnerPosition { get; set; } // double
        [Column("playersCount"), Nullable] public int? PlayersCount { get; set; } // int(11)
    }

    [Table("jackpot_bets")]
    public partial class JackpotBets
    {
        [Column("id"), PrimaryKey, Identity] public int Id { get; set; } // int(11)
        [Column("gameId"), NotNull] public int GameId { get; set; } // int(11)
        [Column("uuid"), NotNull] public int Uuid { get; set; } // int(11)
        [Column("login"), NotNull] public string Login { get; set; } // varchar(255)
        [Column("amount"), NotNull] public int Amount { get; set; } // int(11)
        [Column("ticket"), NotNull] public int Ticket { get; set; } // int(11)
    }
    [Table("weapons")]
