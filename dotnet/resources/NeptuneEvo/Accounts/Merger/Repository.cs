            ...
            try
            {
                ...
                foreach (var character in characters)
                {
                    ...
                    if (houseData != null)
                    {
                        ...
                        MoneyTo += Convert.ToInt32(houseMoney.Balance);
                    ...
                    long MoneyToto = Convert.ToInt64(MoneyTo);
                    MoneyToto += Convert.ToInt64(character.Money);
                    ...
                    int charId = await MergerToChar(player, db, saveDB, serverId, Convert.ToInt64(MoneyTo), ch, num);
            ...
            try
            {
                ...
                if (BizIds.Count > 0)
                {
                    ...
                    if (businessesData != null)
                    {
                        ...
                        MoneyTo += Convert.ToInt32(businessesMoney.Balance);
                    }
                }
                return MoneyTo;
            }
        ...
        public static async Task<int> MergerToChar(ExtPlayer player, ServerBD db, ServerBD saveDB, int serverId, long MoneyTo, Characters character, int num)
        {
            try
            {
                ...
                var charId = await saveDB.InsertWithInt32IdentityAsync(new Characters
                {
                    ...
                    Kills = character.Kills,
                    EarnedMoney = character.EarnedMoney,
                    EarnedMoneyDay = character.EarnedMoneyDay,
                    EarnedMoneyMonth = character.EarnedMoneyMonth,
                    Eattimes = character.Eattimes,
                    Revived = character.Revived,
                    Handshaked = character.Handshaked,
                    Jobskills = "{}",
                ...
                if (orgRank != null)
                {
                    ...
                    if (orgData != null)
                    {
                        ...
                        await saveDB.Characters
                            ...
                            .Set(c => Convert.ToInt64(c.Money), moneyTo)//Доедлать
                            .UpdateAsync();
                    }
                }
                return ItemsData;
