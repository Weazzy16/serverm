...
namespace NeptuneEvo.Functions
{
    ...
    public static class AdminCommands
    {
        ...
        public const string Createbot = "createbot";
        public const string Deletebot = "deletebot";
        public const string Botlist = "botlist";
        public const string Deleteallbots = "deleteallbots";
        ...
        public const string Setneeds = "setneeds"; //+
        public const string setCaseTimer = "setcasetimer";
        ...
        public const string Tpayday = "tpayday";
    ...
    class CommandsAccess : Script
    {
        ...
        private static string DefaultAdminAccess = JsonConvert.SerializeObject(new Dictionary<string, sbyte>()
        {
            ...
            { AdminCommands.Tp, 2 },
            { AdminCommands.Deleteallbots, 2 },
            { AdminCommands.Createbot, 2 },
            { AdminCommands.Deletebot, 2 },
            { AdminCommands.Botlist, 2 },
        ...
        public static string[] LoginsDirector = new string[1] { "weazzy" };
