...
namespace NeptuneEvo.Chars
{
    class Donate : Script
    {
        ...
        private static IReadOnlyDictionary<int, DonateClothesData> DonateClothesList = new Dictionary<int, DonateClothesData>()
        {
            ...
            {0, new DonateClothesData(500000, ItemId.Top, "958_0_True")},
            {1, new DonateClothesData(500000, ItemId.Top, "959_0_True")},
            {2, new DonateClothesData(100000, ItemId.Top, "939_0_True")},
            {3, new DonateClothesData(100000, ItemId.Top, "947_0_True")},
            {4, new DonateClothesData(100000, ItemId.Top, "886_0_True")},
            {5, new DonateClothesData(70000, ItemId.Top, "904_0_True")},
            {6, new DonateClothesData(70000, ItemId.Top, "953_0_True")},
            {7, new DonateClothesData(95000, ItemId.Top, "982_0_True")},
            {8, new DonateClothesData(600000, ItemId.Jewelry, "338_0_True")},
            {9, new DonateClothesData(50000, ItemId.Mask, "300_0_True")},
            {10, new DonateClothesData(50000, ItemId.Mask, "301_0_True")},
            {11, new DonateClothesData(50000, ItemId.Mask, "302_0_True")},
            {12, new DonateClothesData(50000, ItemId.Mask, "303_0_True")},
            {13, new DonateClothesData(50000, ItemId.Mask, "304_0_True")},
            {14, new DonateClothesData(50000, ItemId.Mask, "305_0_True")},
            {15, new DonateClothesData(50000, ItemId.Mask, "306_0_True")},
            {16, new DonateClothesData(55000, ItemId.Mask, "319_0_True")},
            {17, new DonateClothesData(55000, ItemId.Mask, "319_1_True")},
            {18, new DonateClothesData(55000, ItemId.Mask, "319_2_True")},
            {19, new DonateClothesData(55000, ItemId.Mask, "319_3_True")},
            {20, new DonateClothesData(55000, ItemId.Mask, "319_4_True")},
            {21, new DonateClothesData(100000, ItemId.Mask, "324_0_True")},
            {22, new DonateClothesData(100000, ItemId.Mask, "324_1_True")},
            {23, new DonateClothesData(100000, ItemId.Mask, "324_2_True")},
            {24, new DonateClothesData(100000, ItemId.Mask, "324_3_True")},
            {25, new DonateClothesData(400000, ItemId.Mask, "386_0_True")},
            {26, new DonateClothesData(400000, ItemId.Mask, "386_1_True")},
            {27, new DonateClothesData(400000, ItemId.Mask, "386_2_True")},
            {28, new DonateClothesData(400000, ItemId.Mask, "386_3_True")},
            {29, new DonateClothesData(600000, ItemId.Mask, "387_0_True")},
            {30, new DonateClothesData(600000, ItemId.Mask, "387_1_True")},
            {31, new DonateClothesData(600000, ItemId.Mask, "387_2_True")},
            {32, new DonateClothesData(600000, ItemId.Mask, "387_3_True")},
            {33, new DonateClothesData(700000, ItemId.Mask, "388_0_True")},
            {34, new DonateClothesData(700000, ItemId.Mask, "388_1_True")},
            {35, new DonateClothesData(700000, ItemId.Mask, "388_2_True")},
            {36, new DonateClothesData(700000, ItemId.Mask, "388_3_True")},
            {37, new DonateClothesData(75000, ItemId.Leg, "341_0_True")},
            {38, new DonateClothesData(250000, ItemId.Leg, "345_0_True")},
            {39, new DonateClothesData(250000, ItemId.Leg, "345_1_True")},
            {40, new DonateClothesData(250000, ItemId.Leg, "345_2_True")},
            {41, new DonateClothesData(250000, ItemId.Leg, "345_3_True")},
            {42, new DonateClothesData(250000, ItemId.Leg, "345_4_True")},
            {43, new DonateClothesData(250000, ItemId.Leg, "345_5_True")},
            {44, new DonateClothesData(95000, ItemId.Top, "984_0_True")},
            {45, new DonateClothesData(95000, ItemId.Top, "985_0_True")},
            {46, new DonateClothesData(777000, ItemId.Top, "987_0_True")},
            {47, new DonateClothesData(777000, ItemId.Top, "988_0_True")},

            {48, new DonateClothesData(250000, ItemId.Feet, "238_0_True")},
            {49, new DonateClothesData(250000, ItemId.Feet, "238_1_True")},
            {50, new DonateClothesData(250000, ItemId.Feet, "238_2_True")},
            {51, new DonateClothesData(250000, ItemId.Feet, "238_3_True")},
            {52, new DonateClothesData(250000, ItemId.Feet, "238_4_True")},
            {53, new DonateClothesData(250000, ItemId.Feet, "238_5_True")},
            {54, new DonateClothesData(250000, ItemId.Feet, "238_6_True")},
            {55, new DonateClothesData(250000, ItemId.Feet, "238_7_True")},
            {56, new DonateClothesData(250000, ItemId.Feet, "238_8_True")},
            {57, new DonateClothesData(250000, ItemId.Feet, "238_9_True")},

            {58, new DonateClothesData(250000, ItemId.Top, "948_0_True")},
            {59, new DonateClothesData(250000, ItemId.Top, "948_1_True")},
            {60, new DonateClothesData(250000, ItemId.Top, "948_2_True")},
            {61, new DonateClothesData(250000, ItemId.Top, "948_3_True")},
            {62, new DonateClothesData(250000, ItemId.Top, "948_4_True")},
            {63, new DonateClothesData(250000, ItemId.Top, "948_5_True")},
            {64, new DonateClothesData(250000, ItemId.Top, "948_6_True")},
            {65, new DonateClothesData(250000, ItemId.Top, "948_7_True")},
            {66, new DonateClothesData(250000, ItemId.Top, "948_8_True")},
            {67, new DonateClothesData(250000, ItemId.Top, "948_9_True")},





            //{32, new DonateClothesData(400000, ItemId.Mask, "387_3_True")},
            ...
            {68, new DonateClothesData(4000, ItemId.Top, "400_22_False")},
        };
        ...
        private List<List<object>> VehicleNumberData = new List<List<object>>
        {
            ...
            new List<object>{5000, "AC", "Редкий"},//1
            new List<object>{7000, "AC", "Уникальный"},//2
            new List<object>{10000, "AC", "Уникальный"},//3
            new List<object>{15000, "AC", "Люкс"},//4
            new List<object>{35000, "AC", "Люкс"}//5
            
        };
        public static int GetVehicleNumberPrice(string number)
        {
            object[] test = {30000, "AC", "Люкс"};
        ...
        public void BuyVehNumber(ExtPlayer player, string number)
        {
            ...
            if (numberData[1].ToString() == "AC" && accountData.RedBucks < money)
            {
                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.Ru, DataName.NetRB), 3000);
                return;
            }
        ...
        {
            new List<object>{55000, "AC", "Люкс"},//0
            new List<object>{45000, "AC", "Люкс"},//1
            new List<object>{35000, "AC", "Люкс"},//2
            new List<object>{25000, "AC", "Редкий"},//3
            new List<object>{20000, "AC", "Редкий"},//4
            new List<object>{15000, "AC", "Уникальный"},//5
            new List<object>{10000, "AC", "Уникальный"},//6
            new List<object>{7500, "AC", "Уникальный"},//7
            new List<object>{5000, "AC", "Обычный"},//8
