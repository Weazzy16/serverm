...
namespace NeptuneEvo.Chars
{
    ...
    public const float MaxInventoryWeight = 50.0f;      // Основной инвентарь
        ...
        public static List<RouletteCaseData> RouletteCasesData = new List<RouletteCaseData> { 
            ...
            Total   10000 - 100.00% 
            */ 
            new RouletteCaseData(ItemId.Case0, "Обычный кейс", 200, new List<RouletteItemData>(), "keys_0", "Кейс, в котором вам могут выпасть валюта, коины, VIP аккаунт и автомобили"), 
            /* 
            ...
            Total   10000 - 100.00% 
            */ 
           new RouletteCaseData(ItemId.Case1,  "Премиум автомобили",                     600,  new List<RouletteItemData>(), "keys_1",  "Транспортный кейс - в этом кейсе будут выпадать транспортные средства различного класса, вплоть до самых премиальных и уникальных"),
new RouletteCaseData(ItemId.Case2,  "Летний пропуск 2022",                  750,  new List<RouletteItemData>(), "keys_2",  "Кейс со всеми призами из Летнего Сезонного пропуска 2022. Доступен ограниченное время."),
new RouletteCaseData(ItemId.Case3,  "Зимний пропуск 2023",                  750,  new List<RouletteItemData>(), "keys_3",  "Кейс со всеми призами из Зимнего Сезонного пропуска 2023. Доступен ограниченное время."),
new RouletteCaseData(ItemId.Case4,  "Летний пропуск 2023",                  750,  new List<RouletteItemData>(), "keys_4",  "Кейс со всеми призами из Летнего Сезонного пропуска 2023. Доступен ограниченное время."),
new RouletteCaseData(ItemId.Case5,  "Летний пропуск 2024",                  800,  new List<RouletteItemData>(), "keys_5",  "Кейс со всеми призами из Летнего Сезонного пропуска 2024. Доступен ограниченное время."),
new RouletteCaseData(ItemId.Case6,  "Коллекция скинов - Лето 2023",         500,  new List<RouletteItemData>(), "keys_6",  "Кейс со скинами на оружие и бронежилеты. Доступен в Летнем сезонном пропуске 2023 года."),
new RouletteCaseData(ItemId.Case7,  "Осенний кейс 2023",                     500,  new List<RouletteItemData>(), "keys_7",  "Осенняя подборка авто, тюнинг обвесов, одежды и скинов доступна для вас. Обновите автопарк, выразите свою индивидульность. Насладитесь осенью!"),
new RouletteCaseData(ItemId.Case8,  "Осенний кейс 2024",                     500,  new List<RouletteItemData>(), "keys_9",  "Осенняя подборка авто, тюнинг обвесов и уникальной одежды доступна для вас. Обновите автопарк, выразите свою индивидульность. Насладитесь осенью!"),
new RouletteCaseData(ItemId.Case9,  "Halloween 2023",                        600,  new List<RouletteItemData>(), "keys_10", "Хэллоуинская подборка авто, бронежилетов, скинов, одежды и анимаций доступна для вас. Насладитесь зловещей атмосферой Хэллоуина!"),
new RouletteCaseData(ItemId.Case10, "Halloween 2024",                        600,  new List<RouletteItemData>(), "keys_8",  "Хэллоуинская подборка авто, бронежилетов, скинов, одежды и анимаций доступна для вас. Насладитесь зловещей атмосферой Хэллоуина!"),
new RouletteCaseData(ItemId.Case11, "Зимний пропуск 2024",                  900,  new List<RouletteItemData>(), "keys_11", "Кейс со всеми призами из Зимнего Сезонного пропуска 2024. Доступен ограниченное время."),
new RouletteCaseData(ItemId.Case12, "Зимний пропуск 2025",                  750,  new List<RouletteItemData>(), "keys_12", "Кейс со всеми призами из Зимнего Сезонного пропуска 2025. Доступен ограниченное время."),
new RouletteCaseData(ItemId.Case13, "Зимняя сказка",                       500,  new List<RouletteItemData>(), "keys_13", "Кейс со скинами на оружие, скинами на бронежилеты, уникальной одеждой."),
new RouletteCaseData(ItemId.Case14, "Новый год 2024",                      500,  new List<RouletteItemData>(), "keys_14", "Кейс со скинами на оружие, скинами на бронежилеты, уникальной одеждой."),
new RouletteCaseData(ItemId.Case15, "Летняя коллекция Neon",               500,  new List<RouletteItemData>(), "keys_15", "Кейс со скинами на оружие, скинами на бронежилеты, уникальной одеждой."),
new RouletteCaseData(ItemId.Case16, "Автомобильная коллекция - Зима 2024",1500, new List<RouletteItemData>(), "keys_16", "Кейс с экзклюзивными автомобилями и обвесами. Доступен в Зимнем сезонном пропуске 2024 года."),
new RouletteCaseData(ItemId.Case17, "Автомобильная коллекция - Зима 2025",1500, new List<RouletteItemData>(), "keys_17", "Кейс с экзклюзивными автомобилями и обвесами. Доступен в Зимнем сезонном пропуске 2025 года."),
new RouletteCaseData(ItemId.Case18, "Автомобильная коллекция - Лето 2024",1500, new List<RouletteItemData>(), "keys_18", "Кейс с экзклюзивными автомобилями и обвесами. Доступен в Летнем сезонном пропуске 2024 года."),
new RouletteCaseData(ItemId.Case19, "Игрушки на плечо 2024",               500,  new List<RouletteItemData>(), "keys_19", "Кейс с игрушками, которые можно повесить на плечо."),
new RouletteCaseData(ItemId.Case20, "Весенний кейс 2024",                  500,  new List<RouletteItemData>(), "keys_20", "Весенняя подборка авто, тюнинг обвесов, анимаций, одежды и скинов доступна для вас. Обновите автопарк, выразите свою индивидуальность. Насладитесь весной!"),
new RouletteCaseData(ItemId.Case21, "Весенний кейс 2025",                  500,  new List<RouletteItemData>(), "keys_21", "Весна вновь с нами! Пополните свою коллекцию яркими авто, стильными обвесами, эффектными анимациями и свежими скинами. Создавайте свой уникальный образ и ловите весеннее настроение на полной скорости!")
        };
        ...
        public static async void InitRoulette()
        {
            ...
            var jsonCat = new List<List<object>>();
            foreach (var cat in RoulleteCategoryList)
            {
                var cd = new List<object> { cat.Name, cat.Image, cat.CaseList };
                jsonCat.Add(cd);
            }
            RoulleteCategoryListJson = JsonConvert.SerializeObject(jsonCat);
            jsonCat.Clear();

            // 2) Загружаем базовые данные кейсов (без призов)
            RouletteCasesData = Settings.ReadAsync("rouletteCasesData", RouletteCasesData);

            await using var db = new ConfigBD("ConfigDB");

            // 3) Загружаем призы из таблицы Roulette
            var rouletteList = await db.Roulette.ToListAsync();
            foreach (var ri in rouletteList)
            {
                int id = (int)ri.CaseId;
                if (id < RouletteCasesData.Count && RouletteCasesData[id] != null)
                {
                    var rc = RouletteCasesData[id];
                    rc.RouletteItemsData.Add(new RouletteItemData(
                        ri.Name, ri.Desc, ri.Image,
                        (int)ri.ValueMin, (int)ri.ValueMax,
                        (int)ri.ReturnRB, (int)ri.Percent,
                        (RouletteColor)ri.Color,
                        ri.IsChatMessage, ri.IsHudMessage,
                        (ItemId)ri.ItemId, ri.ItemData
                    ));
                }
            }

            // 4) Загружаем расписание из новой таблицы caseschedule
            var scheduleList = await db.CaseSchedule.ToListAsync();
            var scheduleDict = scheduleList.ToDictionary(s => s.CaseId);

            // 5) Собираем итоговый JSON
            var jsonData = new List<List<object>>();
            for (int index = 0; index < RouletteCasesData.Count; index++)
            {
                var rc = RouletteCasesData[index];
                ...
                // даты старта/финиша
                if (scheduleDict.TryGetValue(index, out var sched))
                {
                    // ISO 8601
                    itemData.Add(sched.StartCase.ToString("o"));
                    itemData.Add(sched.EndCase.ToString("o"));
                }
                else
                {
                    itemData.Add(null);
                ...
                foreach (var it in rc.RouletteItemsData)
                {
                    itemsData.Add(new List<object>
                    {
                        $"{it.Name} | {it.Desc}",
                        it.Image,
                        it.Color,
        ...
        public static void ChangeAutoNumberInit()
        {
            ...
            PedSystem.Repository.CreateQuest("s_m_m_fiboffice_02", new Vector3(-538.30676, -196.1116, 38.22998), 97.265724f, title: "~y~NPC~w~ Эдвард Дэниелс\nСмена номеров", colShapeEnums: ColShapeEnums.ChangeAutoNumber);
        ...
        public static IReadOnlyDictionary<ItemId, ItemsInfo> ItemsInfo = new Dictionary<ItemId, ItemsInfo>()
{
    ...
    { ItemId.Camera2, new ItemsInfo("Камера видеонаблюдения", "Подойдет для наблюдения", "placingprop", "Размещаемые предметы", NAPI.Util.GetHashKey("prop_snow_cam_03a"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None, "gray", 1.5f, 1, 1) },
        ...
        public static void LoadOtherItemsData(ExtPlayer player, string Name, string Id, int OtherId, int MaxSlots = 0, string selectItemId = "", bool IsArmyCar = false, bool isMyTent = false)
        {
            try
            {
                ...
                else
                {
                    ...
                    //   Log.Write($"[Stock JSON] {fixedJson}");

                    // Теперь отправляем уже очищенный JSON
                    Trigger.ClientEvent(player, "client.inventory.InitOtherDataStock", OtherId, Id, fixedJson, returnData.Item2, selectItemId, IsArmyCar, isMyTent);
                }
            }
            catch (Exception e)
            {
        ...
        public static void BiolinkTimer(ExtPlayer player)
        {
            try
            {
                var sessionData = player.GetSessionData();
                ...
                characterData.BaffTime -= 30;
                if (characterData.BaffTime < 0) characterData.BaffTime = 0;
                MySQL.Query($"UPDATE `characters` SET `baff` = {characterData.BaffTime} WHERE `uuid` = {characterData.UUID}");

                if (characterData.BaffTime <= 0)
                {
                    if (sessionData.TimersData.BiolinkTimer != null)
                    {
                        Timers.Stop(sessionData.TimersData.BiolinkTimer);
                        sessionData.TimersData.BiolinkTimer = null;
                    }
                    sessionData.TimersData.GolodTimer = Timers.Start(145000, () => GolodSystem.GolodTimer(player));
                    sessionData.TimersData.WaterTimer = Timers.Start(115000, () => GolodSystem.WaterTimer(player));
                }
            }
            catch (Exception e)
            {
                Log.Write($"BiolinkTimer Exception: {e.ToString()}");
            }
        }
        #region custom buffs
        private static void SkillBoostTick(ExtPlayer player)
        {
            var sessionData = player.GetSessionData();
            if (sessionData == null) return;
            if (--sessionData.SkillBoostTime <= 0)
            {
                if (sessionData.TimersData.SkillBoostTimer != null) Timers.Stop(sessionData.TimersData.SkillBoostTimer);
                sessionData.TimersData.SkillBoostTimer = null;
                Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, "Эффект биодобавки закончился", 3000);
            }
        }

        private static bool StartSkillBoost(ExtPlayer player, int seconds)
        {
            var sessionData = player.GetSessionData();
            if (sessionData == null || sessionData.SkillBoostTime > 0) return false;
            sessionData.SkillBoostTime = seconds;
            if (sessionData.TimersData.SkillBoostTimer != null) Timers.Stop(sessionData.TimersData.SkillBoostTimer);
            sessionData.TimersData.SkillBoostTimer = Timers.Start(1000, () => SkillBoostTick(player));
            Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, "Вы чувствуете прилив сил", 3000);
            return true;
        }

        private static void HairStylingTick(ExtPlayer player)
        {
            var sessionData = player.GetSessionData();
            if (sessionData == null) return;
            if (--sessionData.HairStyledTime <= 0)
            {
                if (sessionData.TimersData.HairStylingTimer != null) Timers.Stop(sessionData.TimersData.HairStylingTimer);
                sessionData.TimersData.HairStylingTimer = null;
                sessionData.HairStyled = false;
                Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, "Действие стайлинга закончилось", 3000);
            }
        }

        private static bool StartHairStyling(ExtPlayer player, int seconds)
        {
            var sessionData = player.GetSessionData();
            if (sessionData == null || sessionData.HairStyled) return false;
            sessionData.HairStyled = true;
            sessionData.HairStyledTime = seconds;
            if (sessionData.TimersData.HairStylingTimer != null) Timers.Stop(sessionData.TimersData.HairStylingTimer);
            sessionData.TimersData.HairStylingTimer = Timers.Start(1000, () => HairStylingTick(player));
            Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, "Вы аккуратно уложили волосы", 3000);
            return true;
        }

        private static void SalaryBonusTick(ExtPlayer player)
        {
            var sessionData = player.GetSessionData();
            if (sessionData == null) return;
            if (--sessionData.SalaryBonusTime <= 0)
            {
                if (sessionData.TimersData.SalaryBonusTimer != null) Timers.Stop(sessionData.TimersData.SalaryBonusTimer);
                sessionData.TimersData.SalaryBonusTimer = null;
                sessionData.SalaryBonusActive = false;
                Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, "Письмо губернатора перестало действовать", 3000);
            }
        }

        private static bool StartSalaryBonus(ExtPlayer player, int seconds)
        {
            var sessionData = player.GetSessionData();
            if (sessionData == null || sessionData.SalaryBonusActive) return false;
            sessionData.SalaryBonusActive = true;
            sessionData.SalaryBonusTime = seconds;
            if (sessionData.TimersData.SalaryBonusTimer != null) Timers.Stop(sessionData.TimersData.SalaryBonusTimer);
            sessionData.TimersData.SalaryBonusTimer = Timers.Start(1000, () => SalaryBonusTick(player));
            Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, "Оклад временно увеличен", 3000);
            return true;
        }

        private static void RecoveryTick(ExtPlayer player)
        {
            var sessionData = player.GetSessionData();
            if (sessionData == null) return;
            if (sessionData.RecoveryTime-- <= 0)
            {
                if (sessionData.TimersData.RecoveryTimer != null) Timers.Stop(sessionData.TimersData.RecoveryTimer);
                sessionData.TimersData.RecoveryTimer = null;
                return;
            }
            player.Health = Math.Min(player.Health + 9, 100);
        }

        private static void StartRecovery(ExtPlayer player, int ticks)
        {
            var sessionData = player.GetSessionData();
            if (sessionData == null) return;
            sessionData.RecoveryTime = ticks;
            if (sessionData.TimersData.RecoveryTimer != null) Timers.Stop(sessionData.TimersData.RecoveryTimer);
            sessionData.TimersData.RecoveryTimer = Timers.Start(2000, () => RecoveryTick(player));
        }
        #endregion
        public static InventoryItemData GetItemDataBySqlId(string locationName, string location, int sqlId)
        {
            if (!ItemsData.TryGetValue(locationName, out var locationNameItems))
                return null;

            if (!locationNameItems.TryGetValue(location, out var locationItems))
                return null;
