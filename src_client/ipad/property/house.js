...
const
    clientName = "client.ipad.house.",
    rpcName = "rpc.ipad.house.",
    serverName = "server.ipad.house.";
...
gm.events.add(clientName + "init", (_menuAccess, carsData, _residentsData, _houseData, housePos, _garagesData, _houseFurnitures) => {
    ...
    mp.gui.emmit(`window.listernEvent ('ipadHouseInit');`);


    //
    call("client.ipad.cars.init", carsData, menuAccess.includes("inGarage"), menuAccess.includes("sell"));
