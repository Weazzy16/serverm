...
gm.events.add('passport', (data) => {
    ...
    {
        callRemote("client_trycatch", "player/docs", "passport", e.toString());
    }
});
...
gm.events.add('licenses', (data) => {
    ...
    {
        callRemote("client_trycatch", "player/docs", "licenses", e.toString());
    }
});
...
gm.events.add('dochide', () => {
    ...
    {
        callRemote("client_trycatch", "player/docs", "dochide", e.toString());
    }
});
...
gm.events.add('client.docs', (pageId, data) => {
    ...
    {
        callRemote("client_trycatch", "player/docs", "client.docs", e.toString());
    }
});
