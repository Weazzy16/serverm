...
gm.events.add("binoculars.start", async () => {
    ...
    {
        callRemote("client_trycatch", "player/binoculars", "start", e.toString());
    }
});
...
gm.events.add("binoculars.stop", () => {
    ...
    {
        callRemote("client_trycatch", "player/binoculars", "stop", e.toString());
    }
})
...
gm.events.add("playerDeath", (player, reason, killer) =>  {
	try
	{
        if (!global.loggedin) return;
            ...
            return;
		callRemote("TakeWeapon", 0);
	}
	catch (e) 
	{
		callRemote("client_trycatch", "player/binoculars", "playerDeath", e.toString());
	}
});
...
gm.events.add("render", () => {	
    ...
    {
        callRemote("client_trycatch", "player/binoculars", "render", e.toString());
    }
});
...
const distanceBin = (cam, fov) => {
    ...
    {
        callRemote("client_trycatch", "player/binoculars", "distanceBin", e.toString());
    }
}
...
const setFov = (cam) => {
    ...
    {
        callRemote("client_trycatch", "player/binoculars", "setFov", e.toString());
    }
};