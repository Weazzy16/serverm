const
    clientName = "client.tablet.house.",
    rpcName = "rpc.tablet.house.",
    serverName = "server.tablet.house.";
...
gm.events.add(clientName + "init", (_menuAccess, carsData, _residentsData, _houseData, housePos, _garagesData, _houseFurnitures) => {
    ...
    mp.gui.emmit(`window.listernEvent ('tabletHouseInit');`);


    //
    mp.events.call("client.tablet.cars.init", carsData, menuAccess.includes("inGarage"), menuAccess.includes("sell"));
