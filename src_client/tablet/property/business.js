const
    clientName = "client.tablet.business.",
    rpcName = "rpc.tablet.business.",
    serverName = "server.tablet.business.";
...
gm.events.add(clientName + "init", (statsJson, stocksJson, ordersJson) => {
    ...
    mp.gui.emmit(`window.listernEvent ('tabletBusinessInit');`);
    mp.gui.emmit(`window.listernEvent ('tabletBusinessUpdate');`);
});
...
const initStats = () => {
    ...
    mp.gui.emmit(`window.listernEvent ('tabletBusinessStatsInit', '${jsonStats}', '${jsonProducts}', '${jsonUsers}');`);
}

gm.events.add(clientName + "sell", () => {
    mp.events.call('client.tablet.close');
