...
const
    clientName = "client.tablet.taxi.",
    rpcName = "rpc.tablet.taxi.",
    serverName = "server.tablet.taxi.";
...
const onUpdateOrder = () => {
    ...
    mp.gui.emmit(`window.listernEvent ('tablet.taxi.load');`);
...
gm.events.add(clientName + "updateCounter", (price) => {
    ...
    mp.gui.emmit(`window.listernEvent ('tablet.taxi.updateCounter');`);
...
gm.events.add("render", () => {
    ...
    if (Natives.IS_WAYPOINT_ACTIVE ()) {
        ...
        if(returnPosition !== null)
            mp.gui.emmit(`window.listernEvent ('tabletTaxiPos', '${JSON.stringify(returnPosition)}');`);
    }
