...
const
    clientName = "client.tablet.mech.",
    rpcName = "rpc.tablet.mech.",
    serverName = "server.tablet.mech.";
...
const onUpdateOrder = () => {
    ...
    mp.gui.emmit(`window.listernEvent ('tablet.mech.load');`);
...
gm.events.add("render", () => {
    ...
    if (Natives.IS_WAYPOINT_ACTIVE ()) {
        ...
        if(returnPosition !== null)
            mp.gui.emmit(`window.listernEvent ('tabletmechPos', '${JSON.stringify(returnPosition)}');`);
    }
