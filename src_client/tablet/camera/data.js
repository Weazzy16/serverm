...
export const animationList = [
    { name: translateText("Кулак к груди"), dict: "celltablet@self@franklin@", anim: "chest_bump" },
    { name: translateText("Мир"), dict: "celltablet@self@franklin@", anim: "peace" },
    { name: "West Coast", dict: "celltablet@self@franklin@", anim: "west_coast" },
    { name: translateText("Показать на камеру"), dict: "celltablet@self@michael@", anim: "finger_point" },
    { name: translateText("Поправить лицо"), dict: "celltablet@self@michael@", anim: "run_chin" },
    { name: translateText("Размять шею"), dict: "celltablet@self@michael@", anim: "stretch_neck" },
    { name: translateText("Агрессивный фак"), dict: "celltablet@self@trevor@", anim: "aggressive_finger" },
    { name: translateText("Гордый фак"), dict: "celltablet@self@trevor@", anim: "proud_finger" },
    { name: translateText("Перерезать глотку"), dict: "celltablet@self@trevor@", anim: "throat_slit" },
