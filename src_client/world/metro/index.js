...
const GetNextStation = (currentPoint, MaxTrainWayData = TrainWayData.length - 1) => {
    //callRemote("client_trycatch", "world/metro/index", "GetNextStation", `${currentPoint} - ${MaxTrainWayData}`);
...
GetNextPos = (currentPoint, nextPoint) => {
    ...
    {
        callRemote("client_trycatch", "world/metro/index", GetNextPosDebug, e.toString());
...
const OnStartTrain = (trainData = Date.now().toString()) => {
    ...
    {
        callRemote("client_trycatch", "world/metro/index", "OnStartTrain", e.toString());
    }
};
...
gm.events.add("render", () => {
    ...
    {
        callRemote("client_trycatch", "world/metro/index", "render - " + renderTrainDebug, e.toString());
    }
});