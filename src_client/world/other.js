...
gm.events.add('pentload', () => {
	...
	{
		callRemote("client_trycatch", "world/other", "pentload", e.toString());
	}
});
...
gm.events.add('OfficePropLoad', (intid, type, count, unload, load) => {
	...
	{
		callRemote("client_trycatch", "world/other", "OfficePropLoad", e.toString());
	}
});
...
gm.events.add('OfficeAllPropLoad', (intid, count1, count2, count3, count4) => {
	...
	{
		callRemote("client_trycatch", "world/other", "OfficeAllPropLoad", e.toString());
	}
});
...
gm.events.add('garageload', () => {
	...
	{
		callRemote("client_trycatch", "world/other", "garageload", e.toString());
	}
});
...
gm.events.add('setmyview', (type) => { // organizations camera
	...
	{
		callRemote("client_trycatch", "world/other", "setmyview", e.toString());
	}
});
...
gm.events.add('resetmyview', () => {
	...
	{
		callRemote("client_trycatch", "world/other", "resetmyview", e.toString());
	}
});
...
gm.events.add('loadprophere', (myposx, myposy, myposz, stri, inttype) => {
	...
	{
		callRemote("client_trycatch", "world/other", "loadprophere", e.toString());
	}
});
...
gm.events.add('loadpropbyint', (phIntID, stri) => {
	...
	{
		callRemote("client_trycatch", "world/other", "loadpropbyint", e.toString());
	}
});
...
gm.events.add('clearprophere', (myposx, myposy, myposz, stri, inttype) => {
	...
	{
		callRemote("client_trycatch", "world/other", "clearprophere", e.toString());
	}
});
...
gm.events.add('clearpropbyint', (phIntID, stri) => {
	...
	{
		callRemote("client_trycatch", "world/other", "clearpropbyint", e.toString());
	}
});