...
golf.drawGolfHud = function() {
    ...
    {
        callRemote("client_trycatch", "world/golf", "drawGolfHud", e.toString());
    }
};
...
setInterval(() => {
    ...
    {
        callRemote("client_trycatch", "world/golf", "setInterval", e.toString());
    }
}, 1000);
...
golf.rotateShot = function(moveType) {
    ...
    {
        callRemote("client_trycatch", "world/golf", "rotateShot", e.toString());
    }
};
...
golf.createBall = function(x, y, z) {
    ...
    {
        callRemote("client_trycatch", "world/golf", "createBall", e.toString());
    }
};
...
golf.MoveToBall = function() {
    ...
    {
        callRemote("client_trycatch", "world/golf", "MoveToBall", e.toString());
    }
};
...
golf.endShot = function() {
    ...
    {
        callRemote("client_trycatch", "world/golf", "endShot", e.toString());
    }
};
...
golf.dropShot = function() {
    ...
    {
        callRemote("client_trycatch", "world/golf", "dropShot", e.toString());
    }
};
...
golf.idleShot = async function() {
    ...
    {
        callRemote("client_trycatch", "world/golf", "idleShot", e.toString());
    }
};
...
golf.swing = async function() {
    ...
    {
        callRemote("client_trycatch", "world/golf", "swing", e.toString());
    }
};
...
golf.quickmafs = function(dir) {
    ...
    {
        callRemote("client_trycatch", "world/golf", "quickmafs", e.toString());
    }
};
