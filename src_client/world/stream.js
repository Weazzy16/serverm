...
gm.events.add("playerReady", () => {
    ...
    {
        callRemote("client_trycatch", "world/stream", "playerReady", e.toString());
    }
});
...
const addObjectDropData = (object, value) => {
    ...
    {
        callRemote("client_trycatch", "world/stream", "addObjectDropData", e.toString());
    }
}
...
const addObjectFurnitureData = (object) => {
    ...
    {
        callRemote("client_trycatch", "world/stream", "addObjectFurnitureData", e.toString());
    }
}
...
const addObjectData = (object) => {
    ...
    {
        callRemote("client_trycatch", "world/stream", "addObjectData", e.toString());
    }
}
