...
gm.events.add("doorControl", (index, toggled) => { // Устанавливаем какой-то двери статус отдельно
	...
	{
		callRemote("client_trycatch", "world/doors", "doorControl", e.toString());
	}
});
...
gm.events.add("doorsControl", (json) => { // Устанавливаем при входе статус всех дверей
	...
	{
		callRemote("client_trycatch", "world/doors", "doorsControl", e.toString());
	}
});
...
const GetDistDoors = () => {
	...
	{
		callRemote("client_trycatch", "world/doors", "GetDistDoors", e.toString());
	}
}
