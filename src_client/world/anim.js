...
const ClearData = player => {
    ...
    {
        callRemote("client_trycatch", "world/anim", "ClearData", e.toString());
    }
}
...
const UseAnim = async player => {
    ...
    {
        callRemote("client_trycatch", "world/anim", "UseAnim", e.toString());
    }
};
...
gm.events.add("syncCarryng", (player, data) => {
    ...
    {
        callRemote("client_trycatch", "world/anim", "syncCarryng", e.toString());
    }
});
...
setInterval(() => {
    try
    {
        ...
        if (!mp.players.exists(selectPlayer))
            return callRemote("carryng.stop");
    ...
    {
        callRemote("client_trycatch", "world/anim", "time.everySec", e.toString());
    }
}, 1000);
...
gm.events.add("playerQuit", player => {
    ...
    {
        callRemote("client_trycatch", "world/anim", "playerQuit", e.toString());
    }
});
...
gm.events.add('client.animation.stop', () => { // F8
    ...
    {
        callRemote("client_trycatch", "world/anim", "VK_SPACE", e.toString());
    }
});
...
gm.events.add("render", () => {
    ...
    {
        callRemote("client_trycatch", "world/anim", "render", e.toString());
    }
});
...
global.vdist2 = (_Pos1, _Pos2, toggle = true) => {
    ...
    {
        callRemote("client_trycatch", "world/anim", "vdist2", e.toString());
    }
}
...
gm.events.add("Client_CarryPlayer", function (player, target, id) {
	...
	{
		callRemote("client_trycatch", "world/anim", "Client_CarryPlayer", e.toString());
	}
});