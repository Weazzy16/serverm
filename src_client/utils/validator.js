...
global.isInvalidLogin = (str) =>
{
	...
	{
		callRemote("client_trycatch", "utils/validator", "isInvalidLogin", e.toString());
		return true;
	}
}
...
global.isInvalidEmail = (str) =>
{
	...
	{
		callRemote("client_trycatch", "utils/validator", "isInvalidEmail", e.toString());
		return true;
	}
}
...
global.checkName2 = (str) =>
{
	...
	{
		callRemote("client_trycatch", "utils/validator", "checkName2", e.toString());
		return false;
	}
}