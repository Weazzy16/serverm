...
export const animationList = [
    { name: translateText("Кулак к груди"), dict: "cellipad@self@franklin@", anim: "chest_bump" },
    { name: translateText("Мир"), dict: "cellipad@self@franklin@", anim: "peace" },
    { name: "West Coast", dict: "cellipad@self@franklin@", anim: "west_coast" },
    { name: translateText("Показать на камеру"), dict: "cellipad@self@michael@", anim: "finger_point" },
    { name: translateText("Поправить лицо"), dict: "cellipad@self@michael@", anim: "run_chin" },
    { name: translateText("Размять шею"), dict: "cellipad@self@michael@", anim: "stretch_neck" },
    { name: translateText("Агрессивный фак"), dict: "cellipad@self@trevor@", anim: "aggressive_finger" },
    { name: translateText("Гордый фак"), dict: "cellipad@self@trevor@", anim: "proud_finger" },
    { name: translateText("Перерезать глотку"), dict: "cellipad@self@trevor@", anim: "throat_slit" },
