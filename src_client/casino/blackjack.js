...
class Blackjack {
    ...
    DealerClothes (randomNumber, dealerPed) {
		...
		{
			callRemote("client_trycatch", "casino/blackjack", "DealerClothes", e.toString());
		}
    }
    ...
    DealerPedVoiceGroup (randomNumber, dealerPed) {
		...
		{
			callRemote("client_trycatch", "casino/blackjack", "DealerPedVoiceGroup", e.toString());
		}
    }
    ...
    init () {
		...
		{
			callRemote("client_trycatch", "casino/blackjack", "init", e.toString());
		}
    }
    /**
    ...
    onEntityStreamIn(entity) {
		...
		{
			callRemote("client_trycatch", "casino/blackjack", "onEntityStreamIn", e.toString());
		}
    }
    ...
    onPlayerEnterColshape(shape) {
		...
		{
			callRemote("client_trycatch", "casino/blackjack", "onPlayerEnterColshape", e.toString());
		}
    }
    ...
    onPlayerExitColshape(shape) {
		...
		{
			callRemote("client_trycatch", "casino/blackjack", "onPlayerExitColshape", e.toString());
		}
    }
    ...
    onRender () {
		...
		catch (e) 
		{
			...
			callRemote("client_trycatch", "casino/blackjack", "onRender", e.toString());
		}
    }
    ...
    CardValue (card) {
		...
		{
			callRemote("client_trycatch", "casino/blackjack", "CardValue", e.toString());
			return 0;
		}
    }
    ...
    handValue (list) {
		...
		{
			callRemote("client_trycatch", "casino/blackjack", "handValue", e.toString());
			return 0;
		}
    }
    /**
    ...
    pressKeyE() {
		try
		{
			...
			if (this.nearestSeat != null && this.selectTable == null) { // Сесть за стол
				...
				callRemote('server.blackjack.character_occupy_place', this.nearestTable, this.nearestSeat, x, y, z, correctionPosCharacterForSeatInTableToBlackjack[this.nearestSeat - 1][3] + blackjackTables[this.nearestTable][4]);
				return;
		...
		{
			callRemote("client_trycatch", "casino/blackjack", "pressKeyE", e.toString());
		}
    } 
    ...
    async onSelectTable (i, seat, isBet, isBtn) {
		try
		{
			...
			mp.gui.emmit(`window.router.setView("CasinoBlackjack", {betMax: ${blackjackTables[i][0] == "vw_prop_casino_blckjack_01b" ? 250000000 : 50000000}, isBet: ${isBet}, isBtn: ${isBtn}, btnDouble: false, btnSplit: false});`);
			global.menuOpen();
		}
		catch (e) 
		{
			callRemote("client_trycatch", "casino/blackjack", "onSelectTable", e.toString());
		}
    }
    ...
    onLeave () {
		try
		{
			if (!this.game && this.selectTable != null) { // Условие, если игрок уже сидит за столом
				callRemote('server.blackjack.character_leave_place');
				return;
			}
		}
		catch (e) 
		{
			callRemote("client_trycatch", "casino/blackjack", "onLeave", e.toString());
		}
    }
	...
	onSuccessLeave() {
		...
		{
			callRemote("client_trycatch", "casino/blackjack", "onSuccessLeave", e.toString());
		}
	}
    ...
    async GiveCard (i, seat, handSize, card, flipped = false, split = false) {
		...
		{
			callRemote("client_trycatch", "casino/blackjack", "GiveCard", e.toString());
		}
    }
    ...
    async DealerTurnOverCard (i, flipover) {
		...
		{
			callRemote("client_trycatch", "casino/blackjack", "DealerTurnOverCard", e.toString());
		}
    } 
    ...
    SplitHand (i, seat, handSize) {
		...
		{
			callRemote("client_trycatch", "casino/blackjack", "SplitHand", e.toString());
		}
    }
    ...
    RetrieveCards (i, seat) {
		...
		{
			callRemote("client_trycatch", "casino/blackjack", "RetrieveCards", e.toString());
		}
    }
    ...
    getChips (amount) {
		...
		{
			callRemote("client_trycatch", "casino/blackjack", "getChips", e.toString());
			return { sound: "DLC_VW_CHIP_BET_SML_LARGE", prop: "vw_prop_plaq_10kdollar_st" };
		}
    ...
    async PlaceBetChip (i, seat, bet, double, split) {
		...
		{
			callRemote("client_trycatch", "casino/blackjack", "PlaceBetChip", e.toString());
		}
    }
    ...
    PlayDealerAnim (i, animDict, anim) {
		...
		{
			callRemote("client_trycatch", "casino/blackjack", "PlayDealerAnim", e.toString());
		}
    }
    ...
    PlayDealerSpeech (i, speech) {
		...
		{
			callRemote("client_trycatch", "casino/blackjack", "PlayDealerSpeech", e.toString());
		}
    }
    ...
    CanSplitHand() {
		...
		{
			callRemote("client_trycatch", "casino/blackjack", "CanSplitHand", e.toString());
			return false;
		}
    }
    ...
    openBtn (isBet, isBtn) {      
		...
		{
			callRemote("client_trycatch", "casino/blackjack", "openBtn", e.toString());
		}	
    }
}
...
gm.events.add('client.blackjack.setBet', function (value) {
    callRemote('server.blackjack.setBet', global.pInt (value));
});
...
gm.events.add('client.blackjack.btn', function (value) {
    callRemote('server.blackjack.move', value);
});
