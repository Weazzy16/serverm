...
class Scalefrom {
	...
	get isLoaded() {
		...
		{
			callRemote("client_trycatch", "horses/scaleform", "isLoaded", e.toString());
		}
	}
	...
	callFunction(strFunction, ...args) {
		...
		{
			callRemote("client_trycatch", "horses/scaleform", "callFunction", e.toString());
		}
	}
	...
	onUpdate() {
		...
		{
			callRemote("client_trycatch", "horses/scaleform", "onUpdate", e.toString());
		}
	}
	...
	renderFullscreen() {
		...
		{
			callRemote("client_trycatch", "horses/scaleform", "renderFullscreen", e.toString());
		}
	}
	...
	render2D(x, y, width, height) {
		...
		{
			callRemote("client_trycatch", "horses/scaleform", "render2D", e.toString());
		}
	}
	...
	render3D(position, rotation, scale) {
		...
		{
			callRemote("client_trycatch", "horses/scaleform", "render3D", e.toString());
		}
	}
	...
	render3DAdditive(position, rotation, scale) {
		...
		{
			callRemote("client_trycatch", "horses/scaleform", "render3DAdditive", e.toString());
		}
    }
    createRenderTarget(name, model){
		...
		{
			callRemote("client_trycatch", "horses/scaleform", "createRenderTarget", e.toString());
			return -1;
		}
    }
    ...
    renderTarget(name, model, x, y, width, height){
		...
		{
			callRemote("client_trycatch", "horses/scaleform", "renderTarget", e.toString());
		}
    }
...
global.requestScaleformMovie = scaleformHandle => new Promise(async (resolve, reject) => {
	...
	{
		callRemote("client_trycatch", "casino/horses", "requestScaleformMovie", e.toString());
		resolve();
	}
});