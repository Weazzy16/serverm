...
class horsesRacing{
    ...
    static showHourseScreen(gamertags, horse, bets) {
		...
		{
			callRemote("client_trycatch", "horses/index", "showHourseScreen", e.toString());
		}
    }
    ...
    static playSound(sound){
		...
		{
			callRemote("client_trycatch", "horses/index", "playSound", e.toString());
		}
    }
    static showHorseResults(gamertags, results){
		...
		{
			callRemote("client_trycatch", "horses/index", "showHorseResults", e.toString());
		}
    }
    static startHorseRacing(seed = 1, firstHorse = 0, secondHorse = 1, thirdHorse = 2, fourthHorse = 3, fifthHorse = 4, sixthHorse = 6, sync = true) {
		...
		{
			callRemote("client_trycatch", "horses/index", "startHorseRacing", e.toString());
		}
    }
}
...
gm.events.add({
    'playerEnterColshape': (cols)=>{
		...
		{
			callRemote("client_trycatch", "horses/index", "playerEnterColshape", e.toString());
		}
    },
    'render': () => {
		try {
		...
		catch (e) 
		{
			...
			callRemote("client_trycatch", "horses/index", "render", e.toString());
		}
    },
    "playerExitColshape": (cols)=>{
		...
		{
			callRemote("client_trycatch", "horses/index", "playerExitColshape", e.toString());
		}
    },
    "client.horse.SLOT": async (game) => {
		...
		{
			callRemote("client_trycatch", "horses/index", "client.horse.SLOT", e.toString());
		}
    ...
    "client.horse.START_TIMER": (time)=>{
		...
		{
			callRemote("client_trycatch", "horses/index", "client.horse.START_TIMER", e.toString());
		}
    },
    "client.horse.START_RACING": (seed = 1, firstHorse = 0, secondHorse = 1, thirdHorse = 2, fourthHorse = 3, fifthHorse = 4, sixthHorse = 5)=>{
		...
		{
			callRemote("client_trycatch", "horses/index", "client.horse.START_RACING", e.toString());
		}
    },
    "client.horse.SHOW_RESULTS": (gamertags, results)=>{
		...
		{
			callRemote("client_trycatch", "horses/index", "client.horse.SHOW_RESULTS", e.toString());
		}
    },
    "client.horse.SHOW_HORSE": (gamertags, horse, bets)=>{
		...
		{
			callRemote("client_trycatch", "horses/index", "client.horse.SHOW_HORSE", e.toString());
		}
    },
    "client.horse.GET_HORSE": (horse)=>{
		...
		{
			callRemote("client_trycatch", "horses/index", "client.horse.GET_HORSE", e.toString());
		}
    },
    "client.horse.setBet": (horse, bet)=>{
		try
		{
			...
			callRemote('server.horse.setBet', horse, bet);
		}
		catch (e) 
		{
			callRemote("client_trycatch", "horses/index", "client.horse.setBet", e.toString());
		}
    },
    "client.horse.COUNTDOWN_SCREEN": () => {
		...
		{
			callRemote("client_trycatch", "horses/index", "client.horse.COUNTDOWN_SCREEN", e.toString());
		}
    },
    "client.horse.TEARS_SLOT": () =>{
		...
		{
			callRemote("client_trycatch", "horses/index", "client.horse.TEARS_SLOT", e.toString());
		}
    },
    "client.horse.exit": () => {
...
mp.keys.bind(0x45, !false, function () {
    ...
    if (curentSlot != undefined) callRemote('server.horse.SIT_SLOT');
    else global.binderFunctions.horseExit ();
});

global.binderFunctions.horseExit = () => {
    if (global.horsesplaying == true) callRemote('server.horse.TEARS_SLOT');
}