...
global.toggleFlyCam = (toggle) =>
{
	...
	{
		callRemote("client_trycatch", "admin/cinematiccamera", "toggleFlyCam", e.toString());
	}
}
...
gm.events.add("client.flycam", () => {
	try 
	{
		...
		callRemote('invisible', global.flymode);
		global.localplayer.setVisible(!global.flymode, false);
		global.localplayer.freezePosition(global.flymode);
	}
	catch (e) 
	{
		callRemote("client_trycatch", "admin/cinematiccamera", "client.flycam", e.toString());
	}
});
...
gm.events.add("client.flycam.time", (value) => {
	...
	{
		callRemote("client_trycatch", "admin/cinematiccamera", "client.flycam.time", e.toString());
	}
});
