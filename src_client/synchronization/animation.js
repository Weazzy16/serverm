...
const setAnim = (entity, data) => {
	...
	{
		callRemote("client_trycatch", "synchronization/animation", "setAnim", e.toString());
	}
}
...
gm.events.add('taskPlayAnim', async (entity, animDict, animName, flag, clearTasks, attachmentName) => {
	...
	{
		callRemote("client_trycatch", "synchronization/animation", "gm.events.add('taskPlayAnim'", e.toString());
	}
});
...
const setAnimToKey = (entity, status, key) => {
	...
	{
		callRemote("client_trycatch", "synchronization/animation", "PlayAnimToKey", e.toString());
	}
}
