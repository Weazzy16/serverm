...
global.requestNamedPtfxAsset = (fxLib) => new Promise(async (resolve, reject) => {
    ...
    {
        callRemote("client_trycatch", "synchronization/animation", "requestNamedPtfxAsset", e.toString());
        resolve();
    }
})
...
class ParticleFx {
    ...
    constructor(fxLib, fxName, data = {}) {
        try {
            ...
            callRemote("client_trycatch", "synchronization/particleFx", "constructor", e.toString());
        }
    }
    ...
    async load() {
        try {
            ...
            callRemote("client_trycatch", "synchronization/particleFx", "load", e.toString());
        }
    }
    async timeoutRemove(time) {
        try {
            ...
            callRemote("client_trycatch", "synchronization/particleFx", "timeoutRemove", e.toString());
        }
    }
    ...
    objRemove() {
        try {
            ...
            callRemote("client_trycatch", "synchronization/particleFx", "objRemove", e.toString());
        }
    }
    ...
    remove(player, fxHandle) {
        try {
            ...
            callRemote("client_trycatch", "synchronization/particleFx", "remove", e.toString());
        }
    }
    ...
    async playOnCoords(PosX, PosY, PosZ, dellTime = 1000) {
        try {
            ...
            callRemote("client_trycatch", "synchronization/particleFx", "playOnCoords", e.toString());
        }
    }
    async playOnCoordsOnce(PosX, PosY, PosZ, dellTime = 1000) {
        try {
            ...
            callRemote("client_trycatch", "synchronization/particleFx", "playOnCoordsOnce", e.toString());
        }
    }
    async playOnEntity(entity, dellTime = 1000) {
        try {
            ...
            callRemote("client_trycatch", "synchronization/particleFx", "playOnEntity", e.toString());
        }
    }
    async playOnEntityOnce(entity) {
        try {
            ...
            callRemote("client_trycatch", "synchronization/particleFx", "playOnEntityOnce", e.toString());
        }
    }
    async playOnEntityBone(entity, boneName, dellTime = 1000) {
        try {
            ...
            callRemote("client_trycatch", "synchronization/particleFx", "playOnEntityBone", e.toString());
        }
    }
}
...
global.playFXonPos = async (PosX, PosY, PosZ, fxLib, fxName, dellTime = 1000, data = {}) => {
    try {
        ...
        callRemote("client_trycatch", "synchronization/particleFx", "playFXonPos", e.toString());
    }
};
...
global.playFXonPosOnce = async (PosX, PosY, PosZ, fxLib, fxName, dellTime = 1000, data = {}) => {
    try {
		...
		callRemote("client_trycatch", "synchronization/particleFx", "playFXonPosOnce", e.toString());
    }
};
...
global.playFXonEntity = async (entity, fxLib, fxName, dellTime = 1000, data = {}) => {
    try {
		...
		callRemote("client_trycatch", "synchronization/particleFx", "playFXonEntity", e.toString());
    }
};
...
global.playFXonEntityOnce = async (entity, fxLib, fxName, data = {}) => {
    try {
		...
		callRemote("client_trycatch", "synchronization/particleFx", "playFXonEntityOnce", e.toString());
    }
};
...
global.playFXonEntityBone = async (entity, boneName, fxLib, fxName, dellTime = 1000, data = {}) => {
    try {
		...
		callRemote("client_trycatch", "synchronization/particleFx", "playFXonEntityBone", e.toString());
    }
};
