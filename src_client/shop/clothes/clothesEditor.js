...
gm.events.add('client.clothesEditor.open', function () {
    ...
    {
        callRemote("client_trycatch", "shop/clothes/clothesEditor", "client.clothesEditor.open", e.toString());
    }
});
...
gm.events.add('client.clothesEditor.close', () => {
    try
    {
        ...
        global.menuClose();
        callRemote("server.clothesEditor.close");
        openClothesEditor = false;
    }
    catch (e) 
    {
        callRemote("client_trycatch", "shop/clothes/clothesEditor", "client.clothesEditor.close", e.toString());
    }
});
...
gm.events.add('client.clothesEditor.update', (_id, _props, _drawable, _texture) => {
    try {
        ...
        call('notify', 4, 9, 'clothesEditor ' + e.name + ":" + e.message, 3000);
...
gm.events.add('client.clothesEditor.gender', (_gender) => {
    ...
    {
        callRemote("client_trycatch", "shop/clothes/clothesEditor", "client.clothesEditor.gender", e.toString());
    }
});
