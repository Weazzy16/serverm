...
const getTexturesName = (component, _id) => {
    ...
    {
        callRemote("client_trycatch", "shop/clothes/index", "getTexturesName", e.toString());
    }
}
...
const getIndexToTextureName = (TName, index, id) => {
    ...
    {
        callRemote("client_trycatch", "shop/clothes/index", "getIndexToTextureName", e.toString());
        return id;
    }
}
...
const getVariation = (component) => {
    ...
    {
        callRemote("client_trycatch", "shop/clothes/index", "getVariation", e.toString());
    }
}
...
const UpdateComponent = () => {
    ...
    {
        callRemote("client_trycatch", "shop/clothes/index", "UpdateComponent", e.toString());
    }
}
...
gm.events.add('clothes', (act, value) => {
    ...
    {
        callRemote("client_trycatch", "shop/clothes/index", "clothes", e.toString());
    }
});
...
gm.events.add('buyClothes', () => {
    ...
    if (clothes.type !== "Gloves" && typeData) {
        const clothesData = clothes.data[typeData.index][clothes.Variation];
        const texture = clothesData[4][clothes.Textures] ? clothesData[4][clothes.Textures] : clothes.Textures;
        callRemote('buyClothes', clothes.type, clothesData[0], texture, clothes.isDonate);
    } else if (clothes.type === "Gloves") {
        callRemote('buyClothes', clothes.type, clothes.Variation, clothes.Textures, clothes.isDonate);      
    }
});
...
gm.events.add('setComponentVariation', async (componentId, drawableId, textureId) => {
    ...
    {
        callRemote("client_trycatch", "shop/clothes/index", "setComponentVariation", e.toString());
    }
...
gm.events.add('setPropIndex', async (componentId, drawableId, TextureId) => {
    ...
    {
        callRemote("client_trycatch", "shop/clothes/index", "setPropIndex", e.toString());
    }
});
...
gm.events.add(global.renderName ["1s"], () => {
	...
	{
		callRemote("client_trycatch", "world/environment", global.renderName ["1s"], e.toString());
	}
})