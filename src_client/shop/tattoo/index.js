...
gm.events.add('client.tattoo.open', async (price, data) => {
    ...
    {
        callRemote("client_trycatch", "shop/tatoo/index", "client.tattoo.open", e.toString());
    }
});
...
gm.events.add('client.tattoo.update', (act, id, val) => {
	try
	{
		...
		switch (act) {
			case "buy":
				callRemote("buyTattoo", tattooIds.indexOf(id), tattooValues[tattooIds.indexOf(id)]);
				break;
			case "style":
    ...
    {
        callRemote("client_trycatch", "shop/tatoo/index", "client.tattoo.update", e.toString());
    }
});
...
gm.events.add('client.tattoo.close', () => {
    ...
    {
        callRemote("client_trycatch", "shop/tatoo/index", "client.tattoo.close", e.toString());
    }
});
