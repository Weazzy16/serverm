...
const OnClothesBuy = (dictionary, id, texture) => {
    callRemote('server.clothes.buy', dictionary, id, texture, shopData.isDonate);
}
...
const OnBarberBuy = (dictionary, id, color, colorHighlight, opacity) => {
    callRemote('server.barber.buy', dictionary, id, color, colorHighlight, opacity, shopData.isDonate);
}
...
const OnTattooBuy = (dictionary, id) => {
    callRemote('server.tattoo.buy', dictionary, id, shopData.isDonate);
}
