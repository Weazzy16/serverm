...
gm.events.add(clientName + "open", () => {
    ...
    callRemote(serverName + "open", isInit);
});
...
gm.events.add(clientName + "takeAll", () => {//+
    callRemote(serverName + "takeAll");
});

gm.events.add(clientName + "take", (index, isPrem) => {//+
    callRemote(serverName + "take", index, isPrem);
});
...
gm.events.add(clientName + "buyLvl", (index) => {
    callRemote(serverName + "buyLvl", index);
});
...
gm.events.add(clientName + "setMissions", (id) => {
    callRemote(serverName + "setMissions", id);
});
...
const missionImage = "http://royal-role-play.online/cloud/inventoryItems/items/bp.png";
