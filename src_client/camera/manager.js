...
const cameraSerialize = (camera) => {
	...
	{
		callRemote("client_trycatch", "camera/manager", "cameraSerialize", e.toString());
	}
};
...
global.cameraManager = new class {
    ...
    on(eventName, eventFunction) {
		...
		{
			callRemote("client_trycatch", "camera/manager", "global.cameraManager.on", e.toString());
		}
    }
    ...
    fireEvent(eventName, ...args) {
		...
		{
			callRemote("client_trycatch", "camera/manager", "global.cameraManager.fireEvent", e.toString());
		}
    }
    ...
    getCamera(name, isGet = false) {  
		...
		{
			callRemote("client_trycatch", "camera/manager", "global.cameraManager.getCamera", e.toString());
		}
        return camera;
    }
    ...
    deleteCamera(name, ease = false, easeTime = 0) {
		...
		{
			callRemote("client_trycatch", "camera/manager", "global.cameraManager.deleteCamera", e.toString());
		}
    }
    ...
    destroyCamera(camera) {
		...
		{
			callRemote("client_trycatch", "camera/manager", "global.cameraManager.destroyCamera", e.toString());
		}
    }
    ...
    stopCamera(ease = false, easeTime = 0) {
		...
		{
			callRemote("client_trycatch", "camera/manager", "global.cameraManager.stopCamera", e.toString());
		}
    }
    ...
    createCamera(name, position = new mp.Vector3(0, 0, 100), rotation = new mp.Vector3(), fov = 50) {      
		...
		{
			callRemote("client_trycatch", "camera/manager", "global.cameraManager.createCamera", e.toString());
		}
        return camera;
    }
    ...
    setActiveCamera(activeCamera, toggle, ease = false, easeTime = 0) {
		...
		{
			callRemote("client_trycatch", "camera/manager", "global.cameraManager.setActiveCamera", e.toString());
		}
    }
    ...
    _setActiveCamera(activeCamera) {
		...
		{
			callRemote("client_trycatch", "camera/manager", "global.cameraManager._setActiveCamera", e.toString());
		}
    }
    ...
    setActiveCameraWithInterp(activeCamera, position, rotation, duration, easeLocation, easeRotation) {
		...
		{
			callRemote("client_trycatch", "camera/manager", "global.cameraManager.setActiveCameraWithInterp", e.toString());
		}
    }
