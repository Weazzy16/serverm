...
const createVehicle = async (flatbed, data) => {
	...
	{
		callRemote("client_trycatch", "vehicle/vehiclesync", "client.SetVehicleCustomization", e.toString());
	}
}
/*
...
global.getVehicleHeight = (vehicle) => {
	...
	{
		callRemote("client_trycatch", "player/circle", "getVehicleHeight", e.toString());
		return 1;
	}
}