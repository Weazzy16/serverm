...
gm.events.add('client.ticket.end', (ticketText, ticketPrice, cameraLink, isEvac) => {
	try
	{
        ...
        callRemote('server.ticket.end', ticketText, ticketPrice, cameraLink, isEvac);
	}
	catch (e) 
	{
		callRemote("client_trycatch", "vehicle/petrol", "openPetrol", e.toString());
...
gm.events.add('client.ticket.payment', (autoId) => {
	try
	{
        ...
        callRemote('server.ticket.payment', autoId);
	}
	catch (e) 
	{
		callRemote("client_trycatch", "vehicle/petrol", "openPetrol", e.toString());
...
const OnTicketRender = () => {
	...
	{
		callRemote("client_trycatch", "vehicle/petrol", "OnTicketRender", e.toString());
	}
}