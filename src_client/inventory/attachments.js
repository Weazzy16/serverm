...
mp.attachments = {
	...
	addFor: async function(entity, id)
	{
		...
		{
			callRemote("client_trycatch", "inventory/attachments", "addFor", e.toString());
		}
	},
	...
	removeFor: function(entity, id)
	{
		...
		{
			callRemote("client_trycatch", "inventory/attachments", "removeFor", e.toString());
		}
	},
	...
	initFor: function(entity)
	{
		...
		{
			callRemote("client_trycatch", "inventory/attachments", "initFor", e.toString());
		}
	},
	...
	shutdownFor: function(entity)
	{
		...
		{
			callRemote("client_trycatch", "inventory/attachments", "shutdownFor", e.toString());
		}
	},
	...
	register: function(id, model, boneName, offset, rotation, fixedRot = true)
	{
		...
		{
			callRemote("client_trycatch", "inventory/attachments", "register", e.toString());
		}
	},
	...
	unregister: function(id) 
	{
		...
		{
			callRemote("client_trycatch", "inventory/attachments", "unregister", e.toString());
		}
	},
	...
	addLocal: function(attachmentName)
	{
		try
		{
			...
			{
				callRemote("staticAttachments.Add", String (attachmentName));
			}
		}
		catch (e) 
		{
			callRemote("client_trycatch", "inventory/attachments", "addLocal", e.toString());
		}
	},
	...
	removeLocal: function(attachmentName)
	{
		try
		{
			...
			if(entity.__attachments && entity.__attachments.indexOf(attachmentName) !== -1)
			{
				callRemote("staticAttachments.Remove", String (attachmentName));
			}
		}
		catch (e) 
		{
			callRemote("client_trycatch", "inventory/attachments", "removeLocal", e.toString());
		}
	},
...
global.IsLoadEntity = entity => new Promise(async (resolve, reject) => {
	...
	{
		callRemote("client_trycatch", "inventory/attachments", "IsLoadEntity", e.toString());
		resolve();
	}
});
...
global.IsSeatVehicle = () => new Promise(async (resolve, reject) => {
	...
	{
		callRemote("client_trycatch", "inventory/attachments", "IsSeatVehicle", e.toString());
		resolve();
	}
});
...
mp.events.addDataHandler("attachmentsData", (entity, data) =>
{
	...
	{
		callRemote("client_trycatch", "inventory/attachments", "attachmentsData", e.toString());
	}
});
...
gm.events.add("playerReady", () => {
    ...
    {
		callRemote("client_trycatch", "inventory/attachments", "playerReady", e.toString());
    }
});
...
gm.events.add('objecteditor:start', (model, boneName, offset = new mp.Vector3(), rotation = new mp.Vector3(), fixedRot = true) => {
	...
	{
		callRemote("client_trycatch", "inventory/attachments", "objecteditor:start", e.toString());
	}
});
...
const UpdateObj = () => {
	...
	{
		callRemote("client_trycatch", "inventory/attachments", "UpdateObj", e.toString());
	}
}
...
gm.events.add('click', (x, y, upOrDown, leftOrRight, relativeX, relativeY, worldPosition, hitEntity) => {
	...
	{
		callRemote("client_trycatch", "inventory/attachments", "click", e.toString());
	}
});
...
function cancel() {
	...
	{
		callRemote("client_trycatch", "inventory/attachments", "cancel", e.toString());
	}
}
...
function saveChanges() {
	...
	{
		if(!attachEditor.attachment) return;
		callRemote('staticAttachments.Save', attachEditor.object.model, JSON.stringify(attachEditor.offset), JSON.stringify(attachEditor.rotation));
		global.menuClose();
	...
	{
		callRemote("client_trycatch", "inventory/attachments", "saveChanges", e.toString());
	}
}*/
...
function Save() {
	if (Toggled)
	{
		...
		*/
		...
		callRemote('staticAttachments.Save', UseModel, BoneId, JSON.stringify (attachOffset), JSON.stringify (attachRotation));
		DisableEditor();
	}
}
...
const EnableEditor = async (model, boneId) => {
	...
	{
		callRemote("client_trycatch", "inventory/attachments", "EnableEditor", e.toString());
	}
}
...
global.GetMagnitudeOffset = (pos, cursorDirX, cursorDirY, mainScreenX, mainScreenY, offsetX = 0.0, offsetY = 0.0, offsetZ = 0.0) => {
	...
	{
		callRemote("client_trycatch", "inventory/attachments", "GetMagnitudeOffset", e.toString());
	}
}
...
global.DrawAxis = (name, start, end, color) => {
	...
	{
		callRemote("client_trycatch", "inventory/attachments", "DrawAxis", e.toString());
	}
}
