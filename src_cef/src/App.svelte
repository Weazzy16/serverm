<script>
	...
	import MajesticContainers from "@/views/eternal-dev/containers/index.svelte";
	import MajesticGasStation from "@/views/eternal-dev/businesses/gas-station/index.svelte";
	import MajesticBusinessInfo from "@/views/eternal-dev/businesses/info/index.svelte";
	import ChipTuning from "@/views/eternal-dev/chipTuning/index.svelte";
	//market
	import MajesticMarketplace from "@/views/eternal-dev/marketPlace/index.svelte";
	//arest end rozisk
	import MajesticArrest from "@/views/eternal-dev/fractions/arrest/index.svelte";
    import MajesticWanted from "@/views/eternal-dev/fractions/wanted/index.svelte";

	import Gta5devMenu from '@/views/player/gta5devmenu/index.svelte';
	import ActivityWar from "@/views/player/activityWar/index.svelte";

	import CaptureTablet from '@/views/player/captures/index.svelte';
...
//маркет
	...
	// window.router.setView('Gta5devMenu');
	...
	onMount(() => {
		...
		if (!isMultiplayer) {
			...
			// window.router.setView('ActivityWar');
