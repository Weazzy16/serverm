...
<div id="donatepopup">
    ...
    <div class="donatepopup__main">
        ...
        <div class="popup__subtitle">{translateText('popups', 'Пополняйте RB-счёт прямо из игры!  За AstraCoin можно сменить ник, снять варн, купить премиум-одежду, покрутить кейсов, купить подписку, вип-статус, обменять на игровую валюту и сделать еще много всего интересного. Спасибо тебе!')}</div>
        ...
        <div class="popup__input">{translateText('popups', 'Вы получите')} {getDonate(donateText)} AS</div>
        ...
        <div class="donatepopup__payments">
            <div class="box-between">
                <div class="box-column">
                    ...
                    <div class="donatepopup__count">200<span class="red"> AS</span></div>
