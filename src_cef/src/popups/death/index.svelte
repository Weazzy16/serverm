<script>
    ...
    // let title = popupData?.title || "Заголовок по умолчанию";
    // let text = popupData?.text || "Текст по умолчанию";
...
<!--<div class="popup__death_timer">11:26</div> -->
    <div class="popup__death_title">{translateText('popups', 'Вы умираете')}</div>
