...
{#if isLoad}
<div class="donathmenu" style="width: 135.648vh">
    <div class="hmenutop">
    </div>
    <div class="hmenulist">
        {#each vipLists as item, index}
            <div class="block1" on:keypress={() => {}} on:click={() => showPopup (item, index)}>
                <div class="price">
                ...
                <div class="bgitem">
                    ...
                    <img class="item" src="{document.cloud + `donate/premium/${item.img}.svg`}" alt="">
                </div>
                <div class="iteminfo">
