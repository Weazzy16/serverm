...
<div class="donathmenu">
    ...
    <div class="hmenulist">
        <div class="block" on:keypress={() => {}} on:click={() => SetView("Shop")}>
             <div class="bgitem">
                ...
                <img class="item" src="https://imgur.com/PFygXdf.png" alt="">
            </div>
            <div class="headblock">
                <div class="lineh"></div>
                <div class="lineh"></div>
        ...
        <div class="block" on:keypress={() => {}} on:click={() => SetView("Personal")}>
            <div class="bgitem">
               <svg xmlns="http://www.w3.org/2000/svg" width="271" height="291" viewBox="0 0 271 291" fill="none">
                   <g filter="url(#filter0_d_1_5786)">
                       <path d="M133.115 68.3772C134.591 67.525 136.409 67.525 137.885 68.3772L201.098 104.873C202.574 105.725 203.483 107.3 203.483 109.004V181.996C203.483 183.7 202.574 185.275 201.098 186.127L137.885 222.623C136.409 223.475 134.591 223.475 133.115 222.623L69.9024 186.127C68.4263 185.275 67.517 183.7 67.517 181.996V109.004C67.517 107.3 68.4263 105.725 69.9024 104.873L133.115 68.3772Z" fill="url(#paint0_radial_1_5786)" fill-opacity="0.05"></path>
                ...
                <img class="item" src="https://imgur.com/FcpU7nJ.png" alt="">
            </div>
           <div class="headblock">
               <div class="lineh"></div>
               <div class="lineh"></div>
       ...
       <div class="block" on:keypress={() => {}} on:click={() => SetView("Cases")}>
             <div class="bgitem">
                <svg xmlns="http://www.w3.org/2000/svg" width="271" height="291" viewBox="0 0 271 291" fill="none">
                    <g filter="url(#filter0_d_1_5786)">
                        <path d="M133.115 68.3772C134.591 67.525 136.409 67.525 137.885 68.3772L201.098 104.873C202.574 105.725 203.483 107.3 203.483 109.004V181.996C203.483 183.7 202.574 185.275 201.098 186.127L137.885 222.623C136.409 223.475 134.591 223.475 133.115 222.623L69.9024 186.127C68.4263 185.275 67.517 183.7 67.517 181.996V109.004C67.517 107.3 68.4263 105.725 69.9024 104.873L133.115 68.3772Z" fill="url(#paint0_radial_1_5786)" fill-opacity="0.05"></path>
                ...
                <img class="item" src="https://imgur.com/4rkJuas.png" alt="">
            </div>
            <div class="headblock">
                <div class="lineh"></div>
                <div class="lineh"></div>
        ...
        <div class="block" on:keypress={() => {}} on:click={() => SetView("Premium")}>
            <div class="bgitem">
               <svg xmlns="http://www.w3.org/2000/svg" width="271" height="291" viewBox="0 0 271 291" fill="none">
                   <g filter="url(#filter0_d_1_5786)">
                       <path d="M133.115 68.3772C134.591 67.525 136.409 67.525 137.885 68.3772L201.098 104.873C202.574 105.725 203.483 107.3 203.483 109.004V181.996C203.483 183.7 202.574 185.275 201.098 186.127L137.885 222.623C136.409 223.475 134.591 223.475 133.115 222.623L69.9024 186.127C68.4263 185.275 67.517 183.7 67.517 181.996V109.004C67.517 107.3 68.4263 105.725 69.9024 104.873L133.115 68.3772Z" fill="url(#paint0_radial_1_5786)" fill-opacity="0.05"></path>
                ...
                <img class="item" src="https://imgur.com/lTEDORV.png" alt="">
           </div>
           <div class="headblock">
               <div class="lineh"></div>
               <div class="lineh"></div>
