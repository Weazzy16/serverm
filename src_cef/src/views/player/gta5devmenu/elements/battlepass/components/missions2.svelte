...
<div class="battlepass__missions">
    <div class="battlepass__missions_column">
        <div class="box-flex">
            <div class="battlepass__page_button left" on:keypress={() => {}} on:click={() => onPage (-1)}></div>
            <div class="battlepass__column_page first" class:active={selectPage === 0} on:keypress={() => {}} on:click={() => onSelectPage (0)}>1</div>
            <div class="battlepass__column_page" class:active={selectPage === 1} on:keypress={() => {}} on:click={() => onSelectPage (1)}>2</div>
            <div class="battlepass__column_page" class:active={selectPage === 2} on:keypress={() => {}} on:click={() => onSelectPage (2)}>3</div>
            <div class="battlepass__column_page" class:active={selectPage === 3} on:click={() => onSelectPage (3)}>4</div>
            <div class="battlepass__page_button right" on:keypress={() => {}} on:click={() => onPage (1)}></div>
        </div>
