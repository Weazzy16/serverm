...
<div id="newdonate__roulette">
    ...
    <div class="newdonate__roulette-count">
        <div class="newdonate__roulette-circle" class:active={currentCount === 1} on:keypress on:click={() => onCurrentCount (1)}>1</div>
        <div class="newdonate__roulette-circle" class:active={currentCount === 2} on:keypress on:click={() => onCurrentCount (2)}>2</div>
        <div class="newdonate__roulette-circle" class:active={currentCount === 3} on:keypress on:click={() => onCurrentCount (3)}>3</div>
        <div class="newdonate__roulette-circle" class:active={currentCount === 4} on:keypress on:click={() => onCurrentCount (4)}>4</div>
        <div class="newdonate__roulette-circle" class:active={currentCount === 5} on:keypress on:click={() => onCurrentCount (5)}>5</div>

        <div class="newdonate__roulette-circle" class:active={currentCount === 10} on:keypress on:click={() => onCurrentCount (10)}>10</div>
        <div class="newdonate__roulette-circle" class:active={currentCount === 25} on:keypress on:click={() => onCurrentCount (25)}>25</div>
        <div class="newdonate__roulette-circle" class:active={currentCount === 50} on:keypress on:click={() => onCurrentCount (50)}>50</div>
        <div class="newdonate__roulette-circle" class:active={currentCount === 100} on:keypress on:click={() => onCurrentCount (100)}>100</div>
    </div>
    {/if}
    <div class="newdonate__roulette_hidden-box">
        {#if caseData.price > 0}
        <div class="newdonate__roulette-buttons">
            <div class="newdonate__button_small" on:keypress on:click={() => onOpen()}>
