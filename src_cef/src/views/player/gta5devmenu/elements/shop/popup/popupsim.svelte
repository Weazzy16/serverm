...
<div class="opendialogpersm"  on:mouseenter on:mouseleave>
    <div class="dialogpm">
        ...
        <div class="infodial">
            <p>Введите желаемый номер. Номер не должен начинаться с 0. Ваш {getPrice (number)[2]} номер телефона подчеркнет индивидуальность и позволит ощутить себя по-настоящему эксклюзивно! Цена формируется динамически в зависимости от количества символов.</p>
        </div>
        <input type="text" placeholder="XXXX-XXXX" bind:value={number} maxLength={8}>
