<script>
    ...
    // let VehicleArray = [
    //     { Model: "CarModel1", Price: 1000, IsJob: false },
    //     { Model: "CarModel2", Price: 2000, IsJob: false },
    //     { Model: "CarModel3", Price: 3000, IsJob: false },
    //     { Model: "CarModel1", Price: 1000, IsJob: false },
    //     { Model: "CarModel2", Price: 2000, IsJob: false },
    //     { Model: "CarModel3", Price: 3000, IsJob: false },
    //     { Model: "CarModel1", Price: 1000, IsJob: false },
    ...
    <div class="arenda" class:nonactive={SelectVehicle !== -1}>
        <div class="arenda-header">
            <div class="arenda-header__text">
                <div class="arenda-header__title">AstraRENT</div>
                <div class="arenda-header__category">Транспорт</div>
            ...
            <!-- <span class="arendaicon-off"  on:click={onExit} /> -->
             <div class="arenda__esc" on:click={onExit}>ESC</div>
        </div>
        <div class="arenda-main">
            {#each VehicleArray as item, index}
            <div class="arenda-main__element" on:click={() => SelectVehicle = index}>
                ...
                <div class="arenda-text__price">
                    Cтоимость аренды
                </div>
                <div class="arenda-main__price">
                    <!-- <span class="arendaicon-money"/> -->
                    <span>${format("money", GetRentCarCash (item.Price))}</span> / час
                </div>
            </div>
            {/each}
        </div>
