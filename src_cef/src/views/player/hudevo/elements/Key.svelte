...
<div class="hudevo__playerinfo_butt1on {classData}" class:bottom={bottom} class:active={laststate} class:keyPet={keyPet} class:keyDetector={keyDetector} class:keyDonate={keyDonate} class:pressed={state} class:disabled={disabled} class:nonactive={nonactive} on:click={onClick} bind:this={buttonEl} style={style}>
    <slot/>
</div>