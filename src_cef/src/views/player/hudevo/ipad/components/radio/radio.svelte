...
<div class="newphone__radio" in:fade>
    ...
    <div class="newphone__radio_content">
        {#if selectPage == "radio"}
            ...
            <div class="newphone__project_button radio" on:keypress={() => {}} on:click={()=> selectPage = "radioList"}>Sender wechseln</div>
        {/if}
        {#if selectPage == "radioList"}
            <div class="newphone__project_title" in:fade>Sender auswählen</div>
