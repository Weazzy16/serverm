...
<div in:fade class="box-100">
    ...
    <div class="newphone__maps_list">
        ...
        <div class="newphone__project_button mt-0" on:keypress={() => {}} on:click={onStartPoint}>Показать на карте</div>
        <div class="newphone__project_button mt-0" on:keypress={() => {}} on:click={onCancelOrder}>Отменить заказ</div>
    </div>
</div>