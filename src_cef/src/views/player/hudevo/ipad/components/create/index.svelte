...
<div id="fractionscreate">
    <div class="newproject__buttonblock" on:keypress={() => {}} on:click={onClose}>
    ...
    <div class="fractionscreate__element mb-32" class:active={isCrime} on:keypress={() => {}} on:click={() => onSelectType (true)}>
    ...
    <div class="fractionscreate__element" class:active={!isCrime} on:keypress={() => {}} on:click={() => onSelectType (false)}>
        <div class="fractionscreate__checkbox">
            <div class="active"></div>
        </div>
        <div class="box-column">
    ...
    <div class="fractionscreate__button" on:keypress={() => {}} on:click={onCreate}>
        Создать организацию
    </div>
</div>