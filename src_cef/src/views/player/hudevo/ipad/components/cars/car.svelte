...
<div class="newphone__rent_list" in:fade>
   ...
   <!--{#if selectedCar.time == "Аренда"}
        <div class="newphone__project_button rent">Miete verlängern</div>
        <div class="newphone__project_button rent">Mietvertrag kündigen</div>
    {/if}
    <div class="newphone__project_button rent">Auf der Karte anzeigen</div>
    <div class="newphone__project_button rent">Miete verlängern</div>
    <div class="newphone__project_button rent">Mietvertrag kündigen</div>
    <div class="newphone__project_button rent">Auf der Karte anzeigen</div>-->
