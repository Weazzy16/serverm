...
<div class="newphone__contacts" in:fade>
    ...
    {:else}
        ...
        <div class="newphone__contacts_inputblock newphone__project_padding16">
            ...
            <input type="text" class="newphone__contacts_input" placeholder="Suchen" bind:value={searchText} on:focus={onInputFocus} on:blur={onInputBlur}>
        </div>
        <div class="newphone__contacts_info newphone__project_padding16">
            ...
            <div class="box-column">
                ...
                <div>{$charSim == -1 ? "keine Sim-Karte" : $charSim}</div>
            </div>
        </div>
