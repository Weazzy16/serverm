    ...
    const soundList = [
        {
            ...
            url: "cdn/cloud/sound/iphone/notify/aurora.ogg"
        },
        {
            name: translateText('player2', 'Аккорд'),
            url: "cdn/cloud/sound/iphone/notify/chord.ogg"
        },
        {
            name: translateText('player2', 'Бамбук'),
            url: "cdn/cloud/sound/iphone/notify/bamboo.ogg"
        },
        {
            name: translateText('player2', 'Кружочки'),
            url: "cdn/cloud/sound/iphone/notify/circles.ogg"
        },
        {
            name: translateText('player2', 'Успешно'),
            url: "cdn/cloud/sound/iphone/notify/complete.ogg"
        },
        {
            name: translateText('player2', 'Приветствие'),
            url: "cdn/cloud/sound/iphone/notify/hello.ogg"
        },
        {
            name: translateText('player2', 'Ввод'),
            url: "cdn/cloud/sound/iphone/notify/input.ogg"
        },
        {
            name: translateText('player2', 'Ключи'),
            url: "cdn/cloud/sound/iphone/notify/keys.ogg"
        },
        {
            name: translateText('player2', 'Нота'),
            url: "cdn/cloud/sound/iphone/notify/note.ogg"
        },
        {
            name: translateText('player2', 'Попкорн'),
            url: "cdn/cloud/sound/iphone/notify/popcorn.ogg"
        },
        {
            name: translateText('player2', 'Синтезатор'),
            url: "cdn/cloud/sound/iphone/notify/synth.ogg"
        },
        {
            name: translateText('player2', 'На цыпочках'),
            url: "cdn/cloud/sound/iphone/notify/t1.ogg"
        },
        {
            name: translateText('player2', 'Колокольчик'),
            url: "cdn/cloud/sound/iphone/notify/t2.ogg"
        }
    ]
    let data = []
