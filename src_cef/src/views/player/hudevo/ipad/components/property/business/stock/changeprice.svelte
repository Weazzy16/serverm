...
<div class="newphone__rent_list" in:fade>
    <div class="newphone__project_title w-100 fs-18">{translateText('player2', 'Введите наценку от')} {product.minPrice}{getPrefix (selectedProductName, bizType)} bis {product.maxPrice}{getPrefix (selectedProductName, bizType)}:</div>
    <input type="text" class="newphone__ads_input mb-0" placeholder="Preis eingeben" bind:value={price} on:focus={onInputFocus} on:blur={onInputBlur} />
