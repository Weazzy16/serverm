...
<div class="mybizapp">
    <div class="mybizapp__header">
        <div class="btnhead" class:active={selectedViewBusiness === "Menu"} on:keypress={() => {}} on:click={() => onSelectedViewBusiness("Menu")}>
        ...
        <div class="btnhead" class:active={selectedViewBusiness === "Stocks"} on:keypress={() => {}} on:click={() => onSelectedViewBusiness("Stocks")}>
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
